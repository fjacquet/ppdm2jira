...
UserBeanAvatarUrls<PSCustomObject>
#>

function Initialize-UserBeanAvatarUrls {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UserBeanAvatarUrls' | Write-Debug
...
Convert from JSON to UserBeanAvatarUrls<PSCustomObject>
...
UserBeanAvatarUrls<PSCustomObject>
#>
function ConvertFrom-JsonToUserBeanAvatarUrls {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UserBeanAvatarUrls' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserBeanAvatarUrls
