...
function Initialize-AddNotificationsDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AddNotificationsDetails' | Write-Debug
...
function ConvertFrom-JsonToAddNotificationsDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AddNotificationsDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
