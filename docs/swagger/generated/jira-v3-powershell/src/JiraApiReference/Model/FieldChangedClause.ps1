...
function Initialize-FieldChangedClause {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => FieldChangedClause' | Write-Debug
...
function ConvertFrom-JsonToFieldChangedClause {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => FieldChangedClause' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
