...
function Initialize-ContextualConfiguration {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ContextualConfiguration' | Write-Debug
...
function ConvertFrom-JsonToContextualConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ContextualConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
