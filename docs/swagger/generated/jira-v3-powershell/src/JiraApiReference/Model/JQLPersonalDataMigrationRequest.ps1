...
function Initialize-JQLPersonalDataMigrationRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JQLPersonalDataMigrationRequest' | Write-Debug
...
function ConvertFrom-JsonToJQLPersonalDataMigrationRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JQLPersonalDataMigrationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
