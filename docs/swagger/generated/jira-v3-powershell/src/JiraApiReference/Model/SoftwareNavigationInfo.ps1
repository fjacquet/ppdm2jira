...
function Initialize-SoftwareNavigationInfo {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => SoftwareNavigationInfo' | Write-Debug
...
function ConvertFrom-JsonToSoftwareNavigationInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => SoftwareNavigationInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
