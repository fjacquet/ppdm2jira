...
function Initialize-AttachmentArchiveItemReadable {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AttachmentArchiveItemReadable' | Write-Debug
...
function ConvertFrom-JsonToAttachmentArchiveItemReadable {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AttachmentArchiveItemReadable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
