...
function Initialize-CustomFieldContextDefaultValueMultipleGroupPicker {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueMultipleGroupPicker' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldContextDefaultValueMultipleGroupPicker {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueMultipleGroupPicker' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
