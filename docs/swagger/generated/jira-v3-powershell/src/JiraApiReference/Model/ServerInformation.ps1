...
.PARAMETER DisplayUrlConfluence
...
function Initialize-ServerInformation {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ServerInformation' | Write-Debug
...
function ConvertFrom-JsonToServerInformation {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ServerInformation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServerInformation
        $AllProperties = ('baseUrl', 'buildDate', 'buildNumber', 'deploymentType', 'displayUrl', 'displayUrlConfluence', 'displayUrlServicedeskHelpCenter', 'healthChecks', 'scmInfo', 'serverTime', 'serverTimeZone', 'serverTitle', 'version', 'versionNumbers')
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match 'displayUrlConfluence'))) { #optional property not found
            $DisplayUrlConfluence = $null
        } else {
            $DisplayUrlConfluence = $JsonParameters.PSobject.Properties['displayUrlConfluence'].value
        }
