...
function Initialize-CustomFieldOptionUpdate {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldOptionUpdate' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldOptionUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldOptionUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
