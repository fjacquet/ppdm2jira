...
PageBeanComponentWithIssueCount<PSCustomObject>
#>

function Initialize-PageBeanComponentWithIssueCount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanComponentWithIssueCount' | Write-Debug
...
Convert from JSON to PageBeanComponentWithIssueCount<PSCustomObject>
...
PageBeanComponentWithIssueCount<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanComponentWithIssueCount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanComponentWithIssueCount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanComponentWithIssueCount
