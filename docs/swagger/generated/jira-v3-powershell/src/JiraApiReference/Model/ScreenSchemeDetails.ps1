...
function Initialize-ScreenSchemeDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ScreenSchemeDetails' | Write-Debug
...
function ConvertFrom-JsonToScreenSchemeDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ScreenSchemeDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
