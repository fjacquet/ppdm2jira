...
function Initialize-IssueFilterForBulkPropertySet {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueFilterForBulkPropertySet' | Write-Debug
...
function ConvertFrom-JsonToIssueFilterForBulkPropertySet {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueFilterForBulkPropertySet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
