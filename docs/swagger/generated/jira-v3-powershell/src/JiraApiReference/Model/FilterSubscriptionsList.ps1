...
function Initialize-FilterSubscriptionsList {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => FilterSubscriptionsList' | Write-Debug
...
function ConvertFrom-JsonToFilterSubscriptionsList {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => FilterSubscriptionsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
