...
PageBeanIssueTypeScreenSchemeItem<PSCustomObject>
#>

function Initialize-PageBeanIssueTypeScreenSchemeItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanIssueTypeScreenSchemeItem' | Write-Debug
...
Convert from JSON to PageBeanIssueTypeScreenSchemeItem<PSCustomObject>
...
PageBeanIssueTypeScreenSchemeItem<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanIssueTypeScreenSchemeItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanIssueTypeScreenSchemeItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanIssueTypeScreenSchemeItem
