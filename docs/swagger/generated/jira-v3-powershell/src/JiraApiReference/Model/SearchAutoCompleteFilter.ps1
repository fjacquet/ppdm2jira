...
function Initialize-SearchAutoCompleteFilter {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => SearchAutoCompleteFilter' | Write-Debug
...
function ConvertFrom-JsonToSearchAutoCompleteFilter {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => SearchAutoCompleteFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
