...
function Initialize-SecuritySchemeLevelBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => SecuritySchemeLevelBean' | Write-Debug
...
function ConvertFrom-JsonToSecuritySchemeLevelBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => SecuritySchemeLevelBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
