...
function Initialize-WorkflowSchemeUpdateRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowSchemeUpdateRequest' | Write-Debug
...
function ConvertFrom-JsonToWorkflowSchemeUpdateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowSchemeUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
