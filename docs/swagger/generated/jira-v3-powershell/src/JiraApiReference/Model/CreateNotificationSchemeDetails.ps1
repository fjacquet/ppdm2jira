...
function Initialize-CreateNotificationSchemeDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CreateNotificationSchemeDetails' | Write-Debug
...
function ConvertFrom-JsonToCreateNotificationSchemeDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CreateNotificationSchemeDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $AllProperties = ('description', 'name', 'notificationSchemeEvents')
