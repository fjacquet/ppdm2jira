...
function Initialize-UpdateFieldConfigurationSchemeDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdateFieldConfigurationSchemeDetails' | Write-Debug
...
function ConvertFrom-JsonToUpdateFieldConfigurationSchemeDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdateFieldConfigurationSchemeDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
