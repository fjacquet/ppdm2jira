...
PageBeanIssueTypeSchemeMapping<PSCustomObject>
#>

function Initialize-PageBeanIssueTypeSchemeMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanIssueTypeSchemeMapping' | Write-Debug
...
Convert from JSON to PageBeanIssueTypeSchemeMapping<PSCustomObject>
...
PageBeanIssueTypeSchemeMapping<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanIssueTypeSchemeMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanIssueTypeSchemeMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanIssueTypeSchemeMapping
