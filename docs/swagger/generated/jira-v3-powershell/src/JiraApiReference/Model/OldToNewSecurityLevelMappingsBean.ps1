...
function Initialize-OldToNewSecurityLevelMappingsBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => OldToNewSecurityLevelMappingsBean' | Write-Debug
...
function ConvertFrom-JsonToOldToNewSecurityLevelMappingsBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => OldToNewSecurityLevelMappingsBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
