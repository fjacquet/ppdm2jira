...
function Initialize-ContainerForWebhookIDs {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ContainerForWebhookIDs' | Write-Debug
...
function ConvertFrom-JsonToContainerForWebhookIDs {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ContainerForWebhookIDs' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
