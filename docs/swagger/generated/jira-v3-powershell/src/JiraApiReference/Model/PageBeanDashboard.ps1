...
PageBeanDashboard<PSCustomObject>
#>

function Initialize-PageBeanDashboard {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanDashboard' | Write-Debug
...
Convert from JSON to PageBeanDashboard<PSCustomObject>
...
PageBeanDashboard<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanDashboard {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanDashboard' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanDashboard
