...
function Initialize-IssueTypeSchemeMapping {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeSchemeMapping' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeSchemeMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeSchemeMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
