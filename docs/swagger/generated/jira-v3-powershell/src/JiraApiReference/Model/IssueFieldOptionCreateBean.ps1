...
function Initialize-IssueFieldOptionCreateBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueFieldOptionCreateBean' | Write-Debug
...
function ConvertFrom-JsonToIssueFieldOptionCreateBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueFieldOptionCreateBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
