...
function Initialize-WorkflowOperations {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowOperations' | Write-Debug
...
function ConvertFrom-JsonToWorkflowOperations {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowOperations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
