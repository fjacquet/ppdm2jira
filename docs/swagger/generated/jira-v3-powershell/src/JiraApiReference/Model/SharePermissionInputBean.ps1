...
function Initialize-SharePermissionInputBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => SharePermissionInputBean' | Write-Debug
...
function ConvertFrom-JsonToSharePermissionInputBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => SharePermissionInputBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
