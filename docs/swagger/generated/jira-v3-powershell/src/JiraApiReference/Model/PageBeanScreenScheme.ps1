...
PageBeanScreenScheme<PSCustomObject>
#>

function Initialize-PageBeanScreenScheme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanScreenScheme' | Write-Debug
...
Convert from JSON to PageBeanScreenScheme<PSCustomObject>
...
PageBeanScreenScheme<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanScreenScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanScreenScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanScreenScheme
