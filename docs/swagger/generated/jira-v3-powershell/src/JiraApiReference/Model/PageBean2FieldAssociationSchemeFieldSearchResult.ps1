...
PageBean2FieldAssociationSchemeFieldSearchResult<PSCustomObject>
#>

function Initialize-PageBean2FieldAssociationSchemeFieldSearchResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBean2FieldAssociationSchemeFieldSearchResult' | Write-Debug
...
Convert from JSON to PageBean2FieldAssociationSchemeFieldSearchResult<PSCustomObject>
...
PageBean2FieldAssociationSchemeFieldSearchResult<PSCustomObject>
#>
function ConvertFrom-JsonToPageBean2FieldAssociationSchemeFieldSearchResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBean2FieldAssociationSchemeFieldSearchResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBean2FieldAssociationSchemeFieldSearchResult
