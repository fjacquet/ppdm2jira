...
function Initialize-UpdateCustomFieldDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdateCustomFieldDetails' | Write-Debug
...
function ConvertFrom-JsonToUpdateCustomFieldDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdateCustomFieldDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
