...
function Initialize-ConditionGroupConfiguration {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ConditionGroupConfiguration' | Write-Debug
...
function ConvertFrom-JsonToConditionGroupConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ConditionGroupConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
