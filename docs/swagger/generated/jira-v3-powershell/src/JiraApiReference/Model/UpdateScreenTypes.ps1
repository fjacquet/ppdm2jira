...
function Initialize-UpdateScreenTypes {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdateScreenTypes' | Write-Debug
...
function ConvertFrom-JsonToUpdateScreenTypes {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdateScreenTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
