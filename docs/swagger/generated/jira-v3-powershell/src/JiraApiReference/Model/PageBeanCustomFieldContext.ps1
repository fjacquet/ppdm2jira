...
PageBeanCustomFieldContext<PSCustomObject>
#>

function Initialize-PageBeanCustomFieldContext {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanCustomFieldContext' | Write-Debug
...
Convert from JSON to PageBeanCustomFieldContext<PSCustomObject>
...
PageBeanCustomFieldContext<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanCustomFieldContext {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanCustomFieldContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanCustomFieldContext
