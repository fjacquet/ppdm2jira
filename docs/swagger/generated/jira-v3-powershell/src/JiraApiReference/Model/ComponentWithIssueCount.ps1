...
function Initialize-ComponentWithIssueCount {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ComponentWithIssueCount' | Write-Debug
...
function ConvertFrom-JsonToComponentWithIssueCount {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ComponentWithIssueCount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
