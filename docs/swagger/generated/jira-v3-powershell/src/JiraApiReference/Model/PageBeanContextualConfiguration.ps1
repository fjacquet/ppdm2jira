...
PageBeanContextualConfiguration<PSCustomObject>
#>

function Initialize-PageBeanContextualConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanContextualConfiguration' | Write-Debug
...
Convert from JSON to PageBeanContextualConfiguration<PSCustomObject>
...
PageBeanContextualConfiguration<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanContextualConfiguration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanContextualConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanContextualConfiguration
