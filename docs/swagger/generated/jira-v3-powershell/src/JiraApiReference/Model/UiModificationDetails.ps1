...
function Initialize-UiModificationDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UiModificationDetails' | Write-Debug
...
function ConvertFrom-JsonToUiModificationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UiModificationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
