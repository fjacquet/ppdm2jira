...
function Initialize-WorkflowSimpleCondition {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowSimpleCondition' | Write-Debug
...
function ConvertFrom-JsonToWorkflowSimpleCondition {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowSimpleCondition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
