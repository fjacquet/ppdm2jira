...
PageBeanProject<PSCustomObject>
#>

function Initialize-PageBeanProject {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanProject' | Write-Debug
...
Convert from JSON to PageBeanProject<PSCustomObject>
...
PageBeanProject<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanProject {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanProject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanProject
