...
function Initialize-IssuePickerSuggestions {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssuePickerSuggestions' | Write-Debug
...
function ConvertFrom-JsonToIssuePickerSuggestions {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssuePickerSuggestions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
