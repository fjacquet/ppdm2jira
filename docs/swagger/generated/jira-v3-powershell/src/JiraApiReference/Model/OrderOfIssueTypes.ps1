...
function Initialize-OrderOfIssueTypes {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => OrderOfIssueTypes' | Write-Debug
...
function ConvertFrom-JsonToOrderOfIssueTypes {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => OrderOfIssueTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
