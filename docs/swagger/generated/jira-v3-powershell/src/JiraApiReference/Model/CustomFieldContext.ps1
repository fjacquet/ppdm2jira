...
function Initialize-CustomFieldContext {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldContext' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CustomFieldContext
        $AllProperties = ('description', 'id', 'isAnyIssueType', 'isGlobalContext', 'name')
