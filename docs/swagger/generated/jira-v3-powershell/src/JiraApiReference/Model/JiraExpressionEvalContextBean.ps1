...
function Initialize-JiraExpressionEvalContextBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraExpressionEvalContextBean' | Write-Debug
...
function ConvertFrom-JsonToJiraExpressionEvalContextBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraExpressionEvalContextBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
