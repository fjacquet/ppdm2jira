...
function Initialize-RuleConfiguration {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => RuleConfiguration' | Write-Debug
...
function ConvertFrom-JsonToRuleConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => RuleConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
