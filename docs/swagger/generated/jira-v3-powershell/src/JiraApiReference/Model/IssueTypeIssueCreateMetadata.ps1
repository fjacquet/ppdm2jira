...
function Initialize-IssueTypeIssueCreateMetadata {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeIssueCreateMetadata' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeIssueCreateMetadata {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeIssueCreateMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
