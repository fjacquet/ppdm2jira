...
function Initialize-IssueTypeScreenSchemeItem {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeScreenSchemeItem' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeScreenSchemeItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeScreenSchemeItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
