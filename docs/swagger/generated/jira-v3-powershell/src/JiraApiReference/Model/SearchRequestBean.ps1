...
function Initialize-SearchRequestBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => SearchRequestBean' | Write-Debug
...
function ConvertFrom-JsonToSearchRequestBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => SearchRequestBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
