...
function Initialize-WorkflowSchemeUpdateRequiredMappingsRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowSchemeUpdateRequiredMappingsRequest' | Write-Debug
...
function ConvertFrom-JsonToWorkflowSchemeUpdateRequiredMappingsRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowSchemeUpdateRequiredMappingsRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
