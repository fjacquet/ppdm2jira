...
function Initialize-CreateIssueSecuritySchemeDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CreateIssueSecuritySchemeDetails' | Write-Debug
...
function ConvertFrom-JsonToCreateIssueSecuritySchemeDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CreateIssueSecuritySchemeDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
