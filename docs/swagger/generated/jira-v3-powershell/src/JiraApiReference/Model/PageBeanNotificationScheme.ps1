...
PageBeanNotificationScheme<PSCustomObject>
#>

function Initialize-PageBeanNotificationScheme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanNotificationScheme' | Write-Debug
...
Convert from JSON to PageBeanNotificationScheme<PSCustomObject>
...
PageBeanNotificationScheme<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanNotificationScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanNotificationScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanNotificationScheme
