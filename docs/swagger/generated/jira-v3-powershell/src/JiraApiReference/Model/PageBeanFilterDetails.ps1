...
PageBeanFilterDetails<PSCustomObject>
#>

function Initialize-PageBeanFilterDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanFilterDetails' | Write-Debug
...
Convert from JSON to PageBeanFilterDetails<PSCustomObject>
...
PageBeanFilterDetails<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanFilterDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanFilterDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanFilterDetails
