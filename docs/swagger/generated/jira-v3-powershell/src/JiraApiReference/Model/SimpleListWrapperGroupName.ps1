...
function Initialize-SimpleListWrapperGroupName {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => SimpleListWrapperGroupName' | Write-Debug
...
function ConvertFrom-JsonToSimpleListWrapperGroupName {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => SimpleListWrapperGroupName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
