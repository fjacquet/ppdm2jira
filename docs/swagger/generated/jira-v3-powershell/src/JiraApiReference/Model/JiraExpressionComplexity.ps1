...
function Initialize-JiraExpressionComplexity {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraExpressionComplexity' | Write-Debug
...
function ConvertFrom-JsonToJiraExpressionComplexity {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraExpressionComplexity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
