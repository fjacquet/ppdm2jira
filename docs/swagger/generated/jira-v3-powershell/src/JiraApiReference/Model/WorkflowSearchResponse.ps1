...
WorkflowSearchResponse<PSCustomObject>
#>

function Initialize-WorkflowSearchResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowSearchResponse' | Write-Debug
...
Convert from JSON to WorkflowSearchResponse<PSCustomObject>
...
WorkflowSearchResponse<PSCustomObject>
#>
function ConvertFrom-JsonToWorkflowSearchResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowSearchResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkflowSearchResponse
        $AllProperties = ('isLast', 'maxResults', 'nextPage', 'self', 'startAt', 'statuses', 'total', 'values')
