...
function Initialize-CustomFieldContextDefaultValueForgeMultiUserField {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueForgeMultiUserField' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldContextDefaultValueForgeMultiUserField {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueForgeMultiUserField' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
