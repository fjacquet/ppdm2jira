...
PageBeanResolutionJsonBean<PSCustomObject>
#>

function Initialize-PageBeanResolutionJsonBean {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanResolutionJsonBean' | Write-Debug
...
Convert from JSON to PageBeanResolutionJsonBean<PSCustomObject>
...
PageBeanResolutionJsonBean<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanResolutionJsonBean {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanResolutionJsonBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanResolutionJsonBean
