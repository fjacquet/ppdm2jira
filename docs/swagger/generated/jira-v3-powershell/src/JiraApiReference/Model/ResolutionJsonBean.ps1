...
function Initialize-ResolutionJsonBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ResolutionJsonBean' | Write-Debug
...
function ConvertFrom-JsonToResolutionJsonBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ResolutionJsonBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
