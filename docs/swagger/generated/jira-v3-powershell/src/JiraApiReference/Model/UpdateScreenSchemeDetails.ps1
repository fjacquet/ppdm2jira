...
function Initialize-UpdateScreenSchemeDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdateScreenSchemeDetails' | Write-Debug
...
function ConvertFrom-JsonToUpdateScreenSchemeDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdateScreenSchemeDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
