...
function Initialize-UpdateIssueSecurityLevelDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdateIssueSecurityLevelDetails' | Write-Debug
...
function ConvertFrom-JsonToUpdateIssueSecurityLevelDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdateIssueSecurityLevelDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
