...
function Initialize-WorkflowCapabilities {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowCapabilities' | Write-Debug
...
function ConvertFrom-JsonToWorkflowCapabilities {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowCapabilities' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
