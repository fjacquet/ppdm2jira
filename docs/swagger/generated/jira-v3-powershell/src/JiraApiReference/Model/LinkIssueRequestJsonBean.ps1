...
function Initialize-LinkIssueRequestJsonBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => LinkIssueRequestJsonBean' | Write-Debug
...
function ConvertFrom-JsonToLinkIssueRequestJsonBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => LinkIssueRequestJsonBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
