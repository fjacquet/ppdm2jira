...
function Initialize-WebhookRegistrationDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WebhookRegistrationDetails' | Write-Debug
...
function ConvertFrom-JsonToWebhookRegistrationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WebhookRegistrationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
