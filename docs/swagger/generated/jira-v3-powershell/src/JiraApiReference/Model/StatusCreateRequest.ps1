...
function Initialize-StatusCreateRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => StatusCreateRequest' | Write-Debug
...
function ConvertFrom-JsonToStatusCreateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => StatusCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
