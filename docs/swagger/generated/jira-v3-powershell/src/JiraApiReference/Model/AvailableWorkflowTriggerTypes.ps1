...
function Initialize-AvailableWorkflowTriggerTypes {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AvailableWorkflowTriggerTypes' | Write-Debug
...
function ConvertFrom-JsonToAvailableWorkflowTriggerTypes {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AvailableWorkflowTriggerTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
