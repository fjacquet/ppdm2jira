...
function Initialize-DashboardGadgetPosition {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => DashboardGadgetPosition' | Write-Debug
...
function ConvertFrom-JsonToDashboardGadgetPosition {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => DashboardGadgetPosition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
