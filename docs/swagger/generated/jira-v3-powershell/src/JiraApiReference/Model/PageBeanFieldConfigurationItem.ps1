...
PageBeanFieldConfigurationItem<PSCustomObject>
#>

function Initialize-PageBeanFieldConfigurationItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanFieldConfigurationItem' | Write-Debug
...
Convert from JSON to PageBeanFieldConfigurationItem<PSCustomObject>
...
PageBeanFieldConfigurationItem<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanFieldConfigurationItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanFieldConfigurationItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanFieldConfigurationItem
