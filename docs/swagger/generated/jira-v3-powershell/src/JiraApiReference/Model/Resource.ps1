...
function Initialize-Resource {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => Resource' | Write-Debug
...
function ConvertFrom-JsonToResource {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => Resource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Resource
        $AllProperties = ('contentAsByteArray', 'description', 'file', 'filename', 'inputStream', 'open', 'readable', 'uri', 'url')
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match 'contentAsByteArray'))) { #optional property not found
            $ContentAsByteArray = $null
        } else {
            $ContentAsByteArray = $JsonParameters.PSobject.Properties['contentAsByteArray'].value
        }
