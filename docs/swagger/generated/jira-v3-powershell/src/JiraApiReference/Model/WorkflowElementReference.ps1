...
function Initialize-WorkflowElementReference {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowElementReference' | Write-Debug
...
function ConvertFrom-JsonToWorkflowElementReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowElementReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
