...
function Initialize-SecuritySchemeLevelMemberBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => SecuritySchemeLevelMemberBean' | Write-Debug
...
function ConvertFrom-JsonToSecuritySchemeLevelMemberBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => SecuritySchemeLevelMemberBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
