...
function Initialize-BulkIssuePropertyUpdateRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => BulkIssuePropertyUpdateRequest' | Write-Debug
...
function ConvertFrom-JsonToBulkIssuePropertyUpdateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => BulkIssuePropertyUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
