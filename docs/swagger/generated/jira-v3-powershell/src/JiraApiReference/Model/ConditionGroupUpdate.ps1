...
function Initialize-ConditionGroupUpdate {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ConditionGroupUpdate' | Write-Debug
...
function ConvertFrom-JsonToConditionGroupUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ConditionGroupUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
