...
function Initialize-AvailableWorkflowSystemRule {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AvailableWorkflowSystemRule' | Write-Debug
...
function ConvertFrom-JsonToAvailableWorkflowSystemRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AvailableWorkflowSystemRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
