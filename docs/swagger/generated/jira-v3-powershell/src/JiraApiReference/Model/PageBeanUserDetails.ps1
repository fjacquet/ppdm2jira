...
PageBeanUserDetails<PSCustomObject>
#>

function Initialize-PageBeanUserDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanUserDetails' | Write-Debug
...
Convert from JSON to PageBeanUserDetails<PSCustomObject>
...
PageBeanUserDetails<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanUserDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanUserDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanUserDetails
