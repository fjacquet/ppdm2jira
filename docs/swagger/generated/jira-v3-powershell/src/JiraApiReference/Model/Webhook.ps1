...
function Initialize-Webhook {
    ...
    Param (
        ...
        [ValidateSet("jira:issue_created", "jira:issue_updated", "jira:issue_deleted", "comment_created", "comment_updated", "comment_deleted", "issue_property_set", "issue_property_deleted", "sprint_created", "sprint_updated", "sprint_closed", "sprint_deleted", "sprint_started", "jira:version_released", "jira:version_unreleased", "jira:version_created", "jira:version_moved", "jira:version_updated", "jira:version_merged", "jira:version_deleted")]
        [String[]]
        ${Events},
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => Webhook' | Write-Debug
...
function ConvertFrom-JsonToWebhook {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => Webhook' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Webhook
        $AllProperties = ('events', 'expirationDate', 'fieldIdsFilter', 'id', 'issuePropertyKeysFilter', 'jqlFilter', 'url')
