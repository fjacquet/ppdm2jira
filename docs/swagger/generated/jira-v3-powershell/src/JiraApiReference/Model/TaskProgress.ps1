...
function Initialize-TaskProgress {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => TaskProgress' | Write-Debug
...
Convert from JSON to TaskProgress<PSCustomObject>
...
TaskProgress<PSCustomObject>
#>
function ConvertFrom-JsonToTaskProgress {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => TaskProgress' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaskProgress
