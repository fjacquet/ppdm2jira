...
function Initialize-User {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => User' | Write-Debug
...
function ConvertFrom-JsonToUser {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => User' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in User
        $AllProperties = ('accountId', 'accountType', 'active', 'appType', 'applicationRoles', 'avatarUrls', 'displayName', 'emailAddress', 'expand', 'groups', 'guest', 'key', 'locale', 'name', 'self', 'timeZone')
