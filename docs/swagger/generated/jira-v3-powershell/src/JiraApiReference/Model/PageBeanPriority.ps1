...
PageBeanPriority<PSCustomObject>
#>

function Initialize-PageBeanPriority {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanPriority' | Write-Debug
...
Convert from JSON to PageBeanPriority<PSCustomObject>
...
PageBeanPriority<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanPriority {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanPriority' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanPriority
