...
PageBean2GetFieldAssociationSchemeResponse<PSCustomObject>
#>

function Initialize-PageBean2GetFieldAssociationSchemeResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBean2GetFieldAssociationSchemeResponse' | Write-Debug
...
Convert from JSON to PageBean2GetFieldAssociationSchemeResponse<PSCustomObject>
...
PageBean2GetFieldAssociationSchemeResponse<PSCustomObject>
#>
function ConvertFrom-JsonToPageBean2GetFieldAssociationSchemeResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBean2GetFieldAssociationSchemeResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBean2GetFieldAssociationSchemeResponse
