...
function Initialize-TaskProgressBeanObject {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => TaskProgressBeanObject' | Write-Debug
...
function ConvertFrom-JsonToTaskProgressBeanObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => TaskProgressBeanObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
