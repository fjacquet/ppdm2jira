...
function Initialize-IssueTypeSchemeID {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeSchemeID' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeSchemeID {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeSchemeID' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
