...
function Initialize-AppWorkflowTransitionRule {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AppWorkflowTransitionRule' | Write-Debug
...
function ConvertFrom-JsonToAppWorkflowTransitionRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AppWorkflowTransitionRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
