...
function Initialize-JiraExpressionsComplexityBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraExpressionsComplexityBean' | Write-Debug
...
function ConvertFrom-JsonToJiraExpressionsComplexityBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraExpressionsComplexityBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
