...
function Initialize-FieldUpdateOperation {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => FieldUpdateOperation' | Write-Debug
...
function ConvertFrom-JsonToFieldUpdateOperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => FieldUpdateOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
