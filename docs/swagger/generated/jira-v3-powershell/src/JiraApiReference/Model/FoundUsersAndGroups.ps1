...
function Initialize-FoundUsersAndGroups {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => FoundUsersAndGroups' | Write-Debug
...
function ConvertFrom-JsonToFoundUsersAndGroups {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => FoundUsersAndGroups' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
