...
function Initialize-AssociateSecuritySchemeWithProjectDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AssociateSecuritySchemeWithProjectDetails' | Write-Debug
...
function ConvertFrom-JsonToAssociateSecuritySchemeWithProjectDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AssociateSecuritySchemeWithProjectDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
