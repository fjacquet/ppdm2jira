...
function Initialize-DashboardGadgetSettings {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => DashboardGadgetSettings' | Write-Debug
...
function ConvertFrom-JsonToDashboardGadgetSettings {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => DashboardGadgetSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
