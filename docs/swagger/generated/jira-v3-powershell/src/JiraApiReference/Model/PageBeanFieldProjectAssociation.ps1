...
PageBeanFieldProjectAssociation<PSCustomObject>
#>

function Initialize-PageBeanFieldProjectAssociation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanFieldProjectAssociation' | Write-Debug
...
Convert from JSON to PageBeanFieldProjectAssociation<PSCustomObject>
...
PageBeanFieldProjectAssociation<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanFieldProjectAssociation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanFieldProjectAssociation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanFieldProjectAssociation
