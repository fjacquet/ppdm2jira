...
function Initialize-UserPickerUser {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UserPickerUser' | Write-Debug
...
function ConvertFrom-JsonToUserPickerUser {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UserPickerUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserPickerUser
        $AllProperties = ('accountId', 'accountType', 'avatarUrl', 'displayName', 'html', 'key', 'name')
