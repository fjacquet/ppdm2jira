...
function Initialize-ApplicationProperty {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ApplicationProperty' | Write-Debug
...
function ConvertFrom-JsonToApplicationProperty {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ApplicationProperty' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
