...
function Initialize-AnnouncementBannerConfigurationUpdate {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AnnouncementBannerConfigurationUpdate' | Write-Debug
...
function ConvertFrom-JsonToAnnouncementBannerConfigurationUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AnnouncementBannerConfigurationUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
