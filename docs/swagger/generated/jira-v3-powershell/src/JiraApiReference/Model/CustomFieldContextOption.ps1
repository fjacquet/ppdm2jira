...
function Initialize-CustomFieldContextOption {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldContextOption' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldContextOption {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldContextOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
