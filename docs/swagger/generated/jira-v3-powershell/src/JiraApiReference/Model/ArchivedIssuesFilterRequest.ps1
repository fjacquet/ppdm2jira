...
function Initialize-ArchivedIssuesFilterRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ArchivedIssuesFilterRequest' | Write-Debug
...
function ConvertFrom-JsonToArchivedIssuesFilterRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ArchivedIssuesFilterRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
