...
function Initialize-HealthCheckResult {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => HealthCheckResult' | Write-Debug
...
function ConvertFrom-JsonToHealthCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => HealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
