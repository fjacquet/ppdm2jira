...
PageBeanChangelog<PSCustomObject>
#>

function Initialize-PageBeanChangelog {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanChangelog' | Write-Debug
...
Convert from JSON to PageBeanChangelog<PSCustomObject>
...
PageBeanChangelog<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanChangelog {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanChangelog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanChangelog
