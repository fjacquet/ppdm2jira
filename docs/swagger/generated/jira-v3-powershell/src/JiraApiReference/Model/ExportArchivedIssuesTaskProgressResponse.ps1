...
function Initialize-ExportArchivedIssuesTaskProgressResponse {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ExportArchivedIssuesTaskProgressResponse' | Write-Debug
...
function ConvertFrom-JsonToExportArchivedIssuesTaskProgressResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ExportArchivedIssuesTaskProgressResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
