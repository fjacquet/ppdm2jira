...
function Initialize-IssueEntityProperties {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueEntityProperties' | Write-Debug
...
function ConvertFrom-JsonToIssueEntityProperties {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueEntityProperties' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
