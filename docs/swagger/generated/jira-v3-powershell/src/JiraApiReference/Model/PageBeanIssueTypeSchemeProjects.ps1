...
PageBeanIssueTypeSchemeProjects<PSCustomObject>
#>

function Initialize-PageBeanIssueTypeSchemeProjects {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanIssueTypeSchemeProjects' | Write-Debug
...
Convert from JSON to PageBeanIssueTypeSchemeProjects<PSCustomObject>
...
PageBeanIssueTypeSchemeProjects<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanIssueTypeSchemeProjects {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanIssueTypeSchemeProjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanIssueTypeSchemeProjects
