...
PageBeanIssueTypeScreenScheme<PSCustomObject>
#>

function Initialize-PageBeanIssueTypeScreenScheme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanIssueTypeScreenScheme' | Write-Debug
...
Convert from JSON to PageBeanIssueTypeScreenScheme<PSCustomObject>
...
PageBeanIssueTypeScreenScheme<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanIssueTypeScreenScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanIssueTypeScreenScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanIssueTypeScreenScheme
