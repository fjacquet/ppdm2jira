...
function Initialize-JiraExpressionAnalysis {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraExpressionAnalysis' | Write-Debug
...
function ConvertFrom-JsonToJiraExpressionAnalysis {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraExpressionAnalysis' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
