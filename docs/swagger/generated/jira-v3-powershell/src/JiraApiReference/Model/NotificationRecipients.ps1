...
function Initialize-NotificationRecipients {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => NotificationRecipients' | Write-Debug
...
function ConvertFrom-JsonToNotificationRecipients {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => NotificationRecipients' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
