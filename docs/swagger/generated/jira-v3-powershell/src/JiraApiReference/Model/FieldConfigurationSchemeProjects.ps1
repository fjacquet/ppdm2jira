...
function Initialize-FieldConfigurationSchemeProjects {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => FieldConfigurationSchemeProjects' | Write-Debug
...
function ConvertFrom-JsonToFieldConfigurationSchemeProjects {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => FieldConfigurationSchemeProjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
