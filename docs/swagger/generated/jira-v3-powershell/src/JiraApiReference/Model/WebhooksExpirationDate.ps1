...
function Initialize-WebhooksExpirationDate {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WebhooksExpirationDate' | Write-Debug
...
function ConvertFrom-JsonToWebhooksExpirationDate {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WebhooksExpirationDate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
