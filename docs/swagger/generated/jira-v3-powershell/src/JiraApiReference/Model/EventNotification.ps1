...
function Initialize-EventNotification {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => EventNotification' | Write-Debug
...
function ConvertFrom-JsonToEventNotification {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => EventNotification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
