...
function Initialize-IssueTypeScreenSchemesProjects {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeScreenSchemesProjects' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeScreenSchemesProjects {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeScreenSchemesProjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
