...
function Initialize-AttachmentMetadata {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AttachmentMetadata' | Write-Debug
...
function ConvertFrom-JsonToAttachmentMetadata {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AttachmentMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
