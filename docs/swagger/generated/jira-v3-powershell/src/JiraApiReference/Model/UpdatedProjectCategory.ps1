...
function Initialize-UpdatedProjectCategory {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdatedProjectCategory' | Write-Debug
...
function ConvertFrom-JsonToUpdatedProjectCategory {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdatedProjectCategory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
