...
function Initialize-CustomFieldUpdatedContextOptionsList {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldUpdatedContextOptionsList' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldUpdatedContextOptionsList {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldUpdatedContextOptionsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
