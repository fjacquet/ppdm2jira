...
function Initialize-SecuritySchemeMembersRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => SecuritySchemeMembersRequest' | Write-Debug
...
function ConvertFrom-JsonToSecuritySchemeMembersRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => SecuritySchemeMembersRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
