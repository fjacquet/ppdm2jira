...
function Initialize-WorkflowSchemeUpdateRequiredMappingsResponse {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowSchemeUpdateRequiredMappingsResponse' | Write-Debug
...
function ConvertFrom-JsonToWorkflowSchemeUpdateRequiredMappingsResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowSchemeUpdateRequiredMappingsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
