...
function Initialize-RemoveOptionFromIssuesResult {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => RemoveOptionFromIssuesResult' | Write-Debug
...
function ConvertFrom-JsonToRemoveOptionFromIssuesResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => RemoveOptionFromIssuesResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
