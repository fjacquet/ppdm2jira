...
PageBeanIssueTypeToContextMapping<PSCustomObject>
#>

function Initialize-PageBeanIssueTypeToContextMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanIssueTypeToContextMapping' | Write-Debug
...
Convert from JSON to PageBeanIssueTypeToContextMapping<PSCustomObject>
...
PageBeanIssueTypeToContextMapping<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanIssueTypeToContextMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanIssueTypeToContextMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanIssueTypeToContextMapping
