...
PageBeanIssueSecuritySchemeToProjectMapping<PSCustomObject>
#>

function Initialize-PageBeanIssueSecuritySchemeToProjectMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanIssueSecuritySchemeToProjectMapping' | Write-Debug
...
Convert from JSON to PageBeanIssueSecuritySchemeToProjectMapping<PSCustomObject>
...
PageBeanIssueSecuritySchemeToProjectMapping<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanIssueSecuritySchemeToProjectMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanIssueSecuritySchemeToProjectMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanIssueSecuritySchemeToProjectMapping
