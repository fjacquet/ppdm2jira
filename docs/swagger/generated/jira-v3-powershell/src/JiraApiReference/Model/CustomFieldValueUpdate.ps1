...
function Initialize-CustomFieldValueUpdate {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldValueUpdate' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldValueUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldValueUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
