...
function Initialize-JqlFunctionPrecomputationUpdateBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JqlFunctionPrecomputationUpdateBean' | Write-Debug
...
function ConvertFrom-JsonToJqlFunctionPrecomputationUpdateBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JqlFunctionPrecomputationUpdateBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
