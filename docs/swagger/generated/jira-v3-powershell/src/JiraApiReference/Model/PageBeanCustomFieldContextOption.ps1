...
PageBeanCustomFieldContextOption<PSCustomObject>
#>

function Initialize-PageBeanCustomFieldContextOption {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanCustomFieldContextOption' | Write-Debug
...
Convert from JSON to PageBeanCustomFieldContextOption<PSCustomObject>
...
PageBeanCustomFieldContextOption<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanCustomFieldContextOption {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanCustomFieldContextOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanCustomFieldContextOption
