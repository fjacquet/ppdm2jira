...
function Initialize-UserContextVariable {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UserContextVariable' | Write-Debug
...
function ConvertFrom-JsonToUserContextVariable {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UserContextVariable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
