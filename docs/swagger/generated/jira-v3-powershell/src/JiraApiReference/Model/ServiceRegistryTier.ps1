...
function Initialize-ServiceRegistryTier {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ServiceRegistryTier' | Write-Debug
...
function ConvertFrom-JsonToServiceRegistryTier {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ServiceRegistryTier' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
