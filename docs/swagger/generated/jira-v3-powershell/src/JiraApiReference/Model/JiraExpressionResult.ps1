...
function Initialize-JiraExpressionResult {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraExpressionResult' | Write-Debug
...
function ConvertFrom-JsonToJiraExpressionResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraExpressionResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
