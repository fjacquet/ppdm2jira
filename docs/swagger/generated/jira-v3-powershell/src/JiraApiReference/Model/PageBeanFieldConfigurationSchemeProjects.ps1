...
PageBeanFieldConfigurationSchemeProjects<PSCustomObject>
#>

function Initialize-PageBeanFieldConfigurationSchemeProjects {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanFieldConfigurationSchemeProjects' | Write-Debug
...
Convert from JSON to PageBeanFieldConfigurationSchemeProjects<PSCustomObject>
...
PageBeanFieldConfigurationSchemeProjects<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanFieldConfigurationSchemeProjects {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanFieldConfigurationSchemeProjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanFieldConfigurationSchemeProjects
