...
function Initialize-NewUserDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => NewUserDetails' | Write-Debug
        ...
        if ($null -eq $Products) {
            throw "invalid value for 'Products', 'Products' cannot be null."
        }
...
function ConvertFrom-JsonToNewUserDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => NewUserDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match 'products'))) {
            throw "Error! JSON cannot be serialized due to the required property 'products' missing."
        } else {
