...
PageBeanWorkflowScheme<PSCustomObject>
#>

function Initialize-PageBeanWorkflowScheme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanWorkflowScheme' | Write-Debug
...
Convert from JSON to PageBeanWorkflowScheme<PSCustomObject>
...
PageBeanWorkflowScheme<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanWorkflowScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanWorkflowScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanWorkflowScheme
