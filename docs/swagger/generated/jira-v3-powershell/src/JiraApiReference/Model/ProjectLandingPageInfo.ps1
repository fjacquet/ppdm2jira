...
function Initialize-ProjectLandingPageInfo {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ProjectLandingPageInfo' | Write-Debug
...
function ConvertFrom-JsonToProjectLandingPageInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ProjectLandingPageInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
