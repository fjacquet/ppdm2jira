...
function Initialize-CustomFieldReplacement {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldReplacement' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldReplacement {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldReplacement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
