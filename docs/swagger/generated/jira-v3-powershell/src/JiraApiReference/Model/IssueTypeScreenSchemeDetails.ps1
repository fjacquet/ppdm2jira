...
function Initialize-IssueTypeScreenSchemeDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeScreenSchemeDetails' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeScreenSchemeDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeScreenSchemeDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
