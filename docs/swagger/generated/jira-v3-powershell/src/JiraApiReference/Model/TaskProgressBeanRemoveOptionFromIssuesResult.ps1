...
function Initialize-TaskProgressBeanRemoveOptionFromIssuesResult {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => TaskProgressBeanRemoveOptionFromIssuesResult' | Write-Debug
...
function ConvertFrom-JsonToTaskProgressBeanRemoveOptionFromIssuesResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => TaskProgressBeanRemoveOptionFromIssuesResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
