...
function Initialize-UpdateProjectDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdateProjectDetails' | Write-Debug
...
function ConvertFrom-JsonToUpdateProjectDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdateProjectDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateProjectDetails
        $AllProperties = ('assigneeType', 'avatarId', 'categoryId', 'description', 'issueSecurityScheme', 'key', 'lead', 'leadAccountId', 'name', 'notificationScheme', 'permissionScheme', 'releasedProjectKeys', 'url')
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match 'releasedProjectKeys'))) { #optional property not found
            $ReleasedProjectKeys = $null
        } else {
            $ReleasedProjectKeys = $JsonParameters.PSobject.Properties['releasedProjectKeys'].value
        }
