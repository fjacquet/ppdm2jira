...
function Initialize-TimeTrackingDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => TimeTrackingDetails' | Write-Debug
...
function ConvertFrom-JsonToTimeTrackingDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => TimeTrackingDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
