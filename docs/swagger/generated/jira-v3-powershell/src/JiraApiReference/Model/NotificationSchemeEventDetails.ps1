...
function Initialize-NotificationSchemeEventDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => NotificationSchemeEventDetails' | Write-Debug
...
function ConvertFrom-JsonToNotificationSchemeEventDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => NotificationSchemeEventDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
