...
function Initialize-ModelFilter {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ModelFilter' | Write-Debug
...
function ConvertFrom-JsonToModelFilter {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ModelFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelFilter
        $AllProperties = ('approximateLastUsed', 'description', 'editPermissions', 'favourite', 'favouritedCount', 'id', 'jql', 'name', 'owner', 'searchUrl', 'self', 'sharePermissions', 'sharedUsers', 'subscriptions', 'viewUrl')
