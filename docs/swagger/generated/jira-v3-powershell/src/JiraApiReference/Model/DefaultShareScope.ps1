...
function Initialize-DefaultShareScope {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => DefaultShareScope' | Write-Debug
...
function ConvertFrom-JsonToDefaultShareScope {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => DefaultShareScope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
