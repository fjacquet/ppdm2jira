...
function Initialize-MappingsByWorkflow {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => MappingsByWorkflow' | Write-Debug
...
function ConvertFrom-JsonToMappingsByWorkflow {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => MappingsByWorkflow' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
