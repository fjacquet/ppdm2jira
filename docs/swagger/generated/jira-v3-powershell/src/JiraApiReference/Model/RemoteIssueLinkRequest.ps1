...
function Initialize-RemoteIssueLinkRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => RemoteIssueLinkRequest' | Write-Debug
...
function ConvertFrom-JsonToRemoteIssueLinkRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => RemoteIssueLinkRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
