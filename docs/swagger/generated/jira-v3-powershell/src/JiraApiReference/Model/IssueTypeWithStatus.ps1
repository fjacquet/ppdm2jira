...
function Initialize-IssueTypeWithStatus {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeWithStatus' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeWithStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeWithStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
