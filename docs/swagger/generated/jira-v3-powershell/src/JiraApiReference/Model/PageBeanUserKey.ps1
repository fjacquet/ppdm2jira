...
PageBeanUserKey<PSCustomObject>
#>

function Initialize-PageBeanUserKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanUserKey' | Write-Debug
...
Convert from JSON to PageBeanUserKey<PSCustomObject>
...
PageBeanUserKey<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanUserKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanUserKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanUserKey
