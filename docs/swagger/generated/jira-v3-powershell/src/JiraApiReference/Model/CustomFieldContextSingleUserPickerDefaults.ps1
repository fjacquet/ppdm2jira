...
function Initialize-CustomFieldContextSingleUserPickerDefaults {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldContextSingleUserPickerDefaults' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldContextSingleUserPickerDefaults {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldContextSingleUserPickerDefaults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
