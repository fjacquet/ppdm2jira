...
function Initialize-ProjectEmailAddress {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ProjectEmailAddress' | Write-Debug
...
function ConvertFrom-JsonToProjectEmailAddress {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ProjectEmailAddress' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
