...
function Initialize-JqlQueryFieldEntityProperty {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JqlQueryFieldEntityProperty' | Write-Debug
...
function ConvertFrom-JsonToJqlQueryFieldEntityProperty {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JqlQueryFieldEntityProperty' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
