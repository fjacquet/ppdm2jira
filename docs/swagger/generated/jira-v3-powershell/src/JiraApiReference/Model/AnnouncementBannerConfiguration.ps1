...
function Initialize-AnnouncementBannerConfiguration {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AnnouncementBannerConfiguration' | Write-Debug
...
function ConvertFrom-JsonToAnnouncementBannerConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AnnouncementBannerConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
