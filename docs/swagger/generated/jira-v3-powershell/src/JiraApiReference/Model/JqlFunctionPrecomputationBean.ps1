...
function Initialize-JqlFunctionPrecomputationBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JqlFunctionPrecomputationBean' | Write-Debug
...
function ConvertFrom-JsonToJqlFunctionPrecomputationBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JqlFunctionPrecomputationBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
