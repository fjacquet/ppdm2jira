...
function Initialize-IssueTypeScreenSchemeUpdateDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeScreenSchemeUpdateDetails' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeScreenSchemeUpdateDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeScreenSchemeUpdateDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
