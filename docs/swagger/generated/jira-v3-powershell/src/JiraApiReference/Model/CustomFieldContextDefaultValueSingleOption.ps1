...
function Initialize-CustomFieldContextDefaultValueSingleOption {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueSingleOption' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldContextDefaultValueSingleOption {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueSingleOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
