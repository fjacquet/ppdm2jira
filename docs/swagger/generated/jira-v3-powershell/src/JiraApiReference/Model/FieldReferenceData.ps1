...
function Initialize-FieldReferenceData {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => FieldReferenceData' | Write-Debug
...
function ConvertFrom-JsonToFieldReferenceData {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => FieldReferenceData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
