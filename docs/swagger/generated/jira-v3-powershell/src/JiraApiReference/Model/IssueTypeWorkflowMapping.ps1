...
function Initialize-IssueTypeWorkflowMapping {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeWorkflowMapping' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeWorkflowMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeWorkflowMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
