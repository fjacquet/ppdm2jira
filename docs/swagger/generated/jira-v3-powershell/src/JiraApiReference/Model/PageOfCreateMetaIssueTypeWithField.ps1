...
function Initialize-PageOfCreateMetaIssueTypeWithField {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageOfCreateMetaIssueTypeWithField' | Write-Debug
...
function ConvertFrom-JsonToPageOfCreateMetaIssueTypeWithField {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageOfCreateMetaIssueTypeWithField' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
