...
function Initialize-RequiredMappingByIssueType {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => RequiredMappingByIssueType' | Write-Debug
...
function ConvertFrom-JsonToRequiredMappingByIssueType {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => RequiredMappingByIssueType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
