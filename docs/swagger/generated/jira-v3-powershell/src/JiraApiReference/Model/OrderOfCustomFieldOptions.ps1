...
function Initialize-OrderOfCustomFieldOptions {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => OrderOfCustomFieldOptions' | Write-Debug
...
function ConvertFrom-JsonToOrderOfCustomFieldOptions {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => OrderOfCustomFieldOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
