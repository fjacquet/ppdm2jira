...
function Initialize-ProjectDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ProjectDetails' | Write-Debug
...
Convert from JSON to ProjectDetails<PSCustomObject>
...
ProjectDetails<PSCustomObject>
#>
function ConvertFrom-JsonToProjectDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ProjectDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectDetails
