...
function Initialize-VersionIssueCounts {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => VersionIssueCounts' | Write-Debug
...
function ConvertFrom-JsonToVersionIssueCounts {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => VersionIssueCounts' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
