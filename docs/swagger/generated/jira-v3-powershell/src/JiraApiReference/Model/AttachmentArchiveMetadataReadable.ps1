...
function Initialize-AttachmentArchiveMetadataReadable {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AttachmentArchiveMetadataReadable' | Write-Debug
...
function ConvertFrom-JsonToAttachmentArchiveMetadataReadable {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AttachmentArchiveMetadataReadable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
