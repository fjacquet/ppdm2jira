...
function Initialize-SimplifiedHierarchyLevel {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => SimplifiedHierarchyLevel' | Write-Debug
...
function ConvertFrom-JsonToSimplifiedHierarchyLevel {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => SimplifiedHierarchyLevel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
