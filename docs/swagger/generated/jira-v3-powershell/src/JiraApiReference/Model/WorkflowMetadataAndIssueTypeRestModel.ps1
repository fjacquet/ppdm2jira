...
function Initialize-WorkflowMetadataAndIssueTypeRestModel {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowMetadataAndIssueTypeRestModel' | Write-Debug
...
function ConvertFrom-JsonToWorkflowMetadataAndIssueTypeRestModel {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowMetadataAndIssueTypeRestModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
