...
function Initialize-JiraStatus {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraStatus' | Write-Debug
...
function ConvertFrom-JsonToJiraStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JiraStatus
        $AllProperties = ('description', 'id', 'name', 'scope', 'statusCategory')
