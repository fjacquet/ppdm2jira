...
PageBeanPriorityWithSequence<PSCustomObject>
#>

function Initialize-PageBeanPriorityWithSequence {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanPriorityWithSequence' | Write-Debug
...
Convert from JSON to PageBeanPriorityWithSequence<PSCustomObject>
...
PageBeanPriorityWithSequence<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanPriorityWithSequence {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanPriorityWithSequence' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanPriorityWithSequence
