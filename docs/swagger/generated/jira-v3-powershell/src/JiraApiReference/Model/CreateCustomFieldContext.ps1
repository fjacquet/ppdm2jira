...
function Initialize-CreateCustomFieldContext {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CreateCustomFieldContext' | Write-Debug
...
function ConvertFrom-JsonToCreateCustomFieldContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CreateCustomFieldContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
