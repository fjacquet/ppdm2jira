...
function Initialize-IssueTypeCreateBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeCreateBean' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeCreateBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeCreateBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
