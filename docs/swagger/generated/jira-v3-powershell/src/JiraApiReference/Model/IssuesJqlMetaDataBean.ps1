...
function Initialize-IssuesJqlMetaDataBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssuesJqlMetaDataBean' | Write-Debug
...
function ConvertFrom-JsonToIssuesJqlMetaDataBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssuesJqlMetaDataBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
