...
function Initialize-AssociatedItemBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AssociatedItemBean' | Write-Debug
...
function ConvertFrom-JsonToAssociatedItemBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AssociatedItemBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
