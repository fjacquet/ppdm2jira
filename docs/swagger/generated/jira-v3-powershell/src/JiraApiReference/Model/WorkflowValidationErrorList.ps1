...
function Initialize-WorkflowValidationErrorList {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowValidationErrorList' | Write-Debug
...
function ConvertFrom-JsonToWorkflowValidationErrorList {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowValidationErrorList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
