...
function Initialize-CustomFieldContextDefaultValueCascadingOption {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueCascadingOption' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldContextDefaultValueCascadingOption {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueCascadingOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
