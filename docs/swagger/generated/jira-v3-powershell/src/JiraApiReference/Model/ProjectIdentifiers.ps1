...
function Initialize-ProjectIdentifiers {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ProjectIdentifiers' | Write-Debug
...
function ConvertFrom-JsonToProjectIdentifiers {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ProjectIdentifiers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
