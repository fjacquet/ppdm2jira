...
PageBeanComment<PSCustomObject>
#>

function Initialize-PageBeanComment {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanComment' | Write-Debug
...
Convert from JSON to PageBeanComment<PSCustomObject>
...
PageBeanComment<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanComment {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanComment
