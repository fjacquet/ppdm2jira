...
function Initialize-PermissionDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PermissionDetails' | Write-Debug
...
function ConvertFrom-JsonToPermissionDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PermissionDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
