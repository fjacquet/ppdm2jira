...
PageBeanVersion<PSCustomObject>
#>

function Initialize-PageBeanVersion {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanVersion' | Write-Debug
...
Convert from JSON to PageBeanVersion<PSCustomObject>
...
PageBeanVersion<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanVersion {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanVersion' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanVersion
