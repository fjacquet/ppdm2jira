...
function Initialize-WorkflowTransitions {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowTransitions' | Write-Debug
...
function ConvertFrom-JsonToWorkflowTransitions {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowTransitions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkflowTransitions
        $AllProperties = ('actions', 'conditions', 'customIssueEventId', 'description', 'id', 'links', 'name', 'properties', 'toStatusReference', 'transitionScreen', 'triggers', 'type', 'validators')
