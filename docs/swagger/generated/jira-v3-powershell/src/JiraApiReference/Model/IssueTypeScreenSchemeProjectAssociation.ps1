...
function Initialize-IssueTypeScreenSchemeProjectAssociation {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeScreenSchemeProjectAssociation' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeScreenSchemeProjectAssociation {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeScreenSchemeProjectAssociation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
