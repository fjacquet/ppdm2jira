...
function Initialize-IssueFieldOptionScopeBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueFieldOptionScopeBean' | Write-Debug
...
function ConvertFrom-JsonToIssueFieldOptionScopeBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueFieldOptionScopeBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
