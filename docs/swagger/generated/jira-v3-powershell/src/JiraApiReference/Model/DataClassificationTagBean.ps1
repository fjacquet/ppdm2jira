...
function Initialize-DataClassificationTagBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => DataClassificationTagBean' | Write-Debug
...
function ConvertFrom-JsonToDataClassificationTagBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => DataClassificationTagBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DataClassificationTagBean
        $AllProperties = ('color', 'description', 'guideline', 'guidelineADF', 'id', 'name', 'rank', 'status')
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match 'guidelineADF'))) { #optional property not found
            $GuidelineADF = $null
        } else {
            $GuidelineADF = $JsonParameters.PSobject.Properties['guidelineADF'].value
        }
