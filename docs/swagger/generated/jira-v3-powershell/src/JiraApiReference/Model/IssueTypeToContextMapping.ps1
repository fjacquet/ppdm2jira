...
function Initialize-IssueTypeToContextMapping {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeToContextMapping' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeToContextMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeToContextMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
