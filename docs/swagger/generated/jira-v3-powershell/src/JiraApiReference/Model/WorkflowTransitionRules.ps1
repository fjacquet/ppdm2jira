...
function Initialize-WorkflowTransitionRules {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowTransitionRules' | Write-Debug
...
function ConvertFrom-JsonToWorkflowTransitionRules {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowTransitionRules' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
