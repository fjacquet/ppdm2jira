...
PageBeanGroupDetails<PSCustomObject>
#>

function Initialize-PageBeanGroupDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanGroupDetails' | Write-Debug
...
Convert from JSON to PageBeanGroupDetails<PSCustomObject>
...
PageBeanGroupDetails<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanGroupDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanGroupDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanGroupDetails
