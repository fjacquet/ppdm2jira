...
PageBeanSecuritySchemeWithProjects<PSCustomObject>
#>

function Initialize-PageBeanSecuritySchemeWithProjects {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanSecuritySchemeWithProjects' | Write-Debug
...
Convert from JSON to PageBeanSecuritySchemeWithProjects<PSCustomObject>
...
PageBeanSecuritySchemeWithProjects<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanSecuritySchemeWithProjects {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanSecuritySchemeWithProjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanSecuritySchemeWithProjects
