...
function Initialize-IssueSecuritySchemeToProjectMapping {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueSecuritySchemeToProjectMapping' | Write-Debug
...
function ConvertFrom-JsonToIssueSecuritySchemeToProjectMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueSecuritySchemeToProjectMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
