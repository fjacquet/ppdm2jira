...
function Initialize-WorkflowStatusLayout {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowStatusLayout' | Write-Debug
...
function ConvertFrom-JsonToWorkflowStatusLayout {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowStatusLayout' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
