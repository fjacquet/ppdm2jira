...
function Initialize-SanitizedJqlQuery {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => SanitizedJqlQuery' | Write-Debug
...
function ConvertFrom-JsonToSanitizedJqlQuery {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => SanitizedJqlQuery' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
