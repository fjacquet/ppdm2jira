...
JiraExpressionEvaluateContextBean<PSCustomObject>
#>

function Initialize-JiraExpressionEvaluateContextBean {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraExpressionEvaluateContextBean' | Write-Debug
...
Convert from JSON to JiraExpressionEvaluateContextBean<PSCustomObject>
...
JiraExpressionEvaluateContextBean<PSCustomObject>
#>
function ConvertFrom-JsonToJiraExpressionEvaluateContextBean {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraExpressionEvaluateContextBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JiraExpressionEvaluateContextBean
