...
function Initialize-UpdateNotificationSchemeDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdateNotificationSchemeDetails' | Write-Debug
...
function ConvertFrom-JsonToUpdateNotificationSchemeDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdateNotificationSchemeDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
