...
PageBeanField<PSCustomObject>
#>

function Initialize-PageBeanField {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanField' | Write-Debug
...
Convert from JSON to PageBeanField<PSCustomObject>
...
PageBeanField<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanField {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanField' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanField
