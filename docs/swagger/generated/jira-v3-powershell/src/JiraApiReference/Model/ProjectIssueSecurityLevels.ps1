...
function Initialize-ProjectIssueSecurityLevels {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ProjectIssueSecurityLevels' | Write-Debug
...
function ConvertFrom-JsonToProjectIssueSecurityLevels {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ProjectIssueSecurityLevels' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
