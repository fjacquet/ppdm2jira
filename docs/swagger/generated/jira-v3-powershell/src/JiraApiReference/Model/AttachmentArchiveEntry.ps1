...
function Initialize-AttachmentArchiveEntry {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AttachmentArchiveEntry' | Write-Debug
...
function ConvertFrom-JsonToAttachmentArchiveEntry {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AttachmentArchiveEntry' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
