...
PageBeanUser<PSCustomObject>
#>

function Initialize-PageBeanUser {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanUser' | Write-Debug
...
Convert from JSON to PageBeanUser<PSCustomObject>
...
PageBeanUser<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanUser {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanUser
