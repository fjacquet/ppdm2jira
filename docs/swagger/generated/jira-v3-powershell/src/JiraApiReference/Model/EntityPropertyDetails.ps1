...
function Initialize-EntityPropertyDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => EntityPropertyDetails' | Write-Debug
...
function ConvertFrom-JsonToEntityPropertyDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => EntityPropertyDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
