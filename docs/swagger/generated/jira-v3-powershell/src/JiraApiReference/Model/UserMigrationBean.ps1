...
function Initialize-UserMigrationBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UserMigrationBean' | Write-Debug
...
function ConvertFrom-JsonToUserMigrationBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UserMigrationBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
