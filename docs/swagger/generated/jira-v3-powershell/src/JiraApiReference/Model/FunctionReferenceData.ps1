...
function Initialize-FunctionReferenceData {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => FunctionReferenceData' | Write-Debug
...
function ConvertFrom-JsonToFunctionReferenceData {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => FunctionReferenceData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
