...
function Initialize-ProjectIssueTypesHierarchyLevel {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ProjectIssueTypesHierarchyLevel' | Write-Debug
...
function ConvertFrom-JsonToProjectIssueTypesHierarchyLevel {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ProjectIssueTypesHierarchyLevel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
