...
function Initialize-CreateProjectDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CreateProjectDetails' | Write-Debug
...
function ConvertFrom-JsonToCreateProjectDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CreateProjectDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateProjectDetails
        $AllProperties = ('assigneeType', 'avatarId', 'categoryId', 'description', 'fieldConfigurationScheme', 'fieldScheme', 'issueSecurityScheme', 'issueTypeScheme', 'issueTypeScreenScheme', 'key', 'lead', 'leadAccountId', 'name', 'notificationScheme', 'permissionScheme', 'projectTemplateKey', 'projectTypeKey', 'url', 'workflowScheme')
