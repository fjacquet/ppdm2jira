...
function Initialize-DateRangeFilterRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => DateRangeFilterRequest' | Write-Debug
...
function ConvertFrom-JsonToDateRangeFilterRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => DateRangeFilterRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
