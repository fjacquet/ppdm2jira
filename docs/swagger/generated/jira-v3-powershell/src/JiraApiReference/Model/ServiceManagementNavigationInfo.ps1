...
function Initialize-ServiceManagementNavigationInfo {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ServiceManagementNavigationInfo' | Write-Debug
...
function ConvertFrom-JsonToServiceManagementNavigationInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ServiceManagementNavigationInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
