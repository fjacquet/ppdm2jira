...
function Initialize-ComponentJsonBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ComponentJsonBean' | Write-Debug
...
function ConvertFrom-JsonToComponentJsonBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ComponentJsonBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
