...
function Initialize-IssueTypeSchemeUpdateDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeSchemeUpdateDetails' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeSchemeUpdateDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeSchemeUpdateDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
