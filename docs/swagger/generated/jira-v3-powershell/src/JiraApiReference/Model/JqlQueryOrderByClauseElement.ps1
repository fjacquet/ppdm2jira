...
function Initialize-JqlQueryOrderByClauseElement {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JqlQueryOrderByClauseElement' | Write-Debug
...
function ConvertFrom-JsonToJqlQueryOrderByClauseElement {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JqlQueryOrderByClauseElement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
