...
function Initialize-NotificationSchemeNotificationDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => NotificationSchemeNotificationDetails' | Write-Debug
...
function ConvertFrom-JsonToNotificationSchemeNotificationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => NotificationSchemeNotificationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
