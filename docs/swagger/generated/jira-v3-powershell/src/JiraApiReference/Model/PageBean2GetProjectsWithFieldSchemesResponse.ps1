...
PageBean2GetProjectsWithFieldSchemesResponse<PSCustomObject>
#>

function Initialize-PageBean2GetProjectsWithFieldSchemesResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBean2GetProjectsWithFieldSchemesResponse' | Write-Debug
...
Convert from JSON to PageBean2GetProjectsWithFieldSchemesResponse<PSCustomObject>
...
PageBean2GetProjectsWithFieldSchemesResponse<PSCustomObject>
#>
function ConvertFrom-JsonToPageBean2GetProjectsWithFieldSchemesResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBean2GetProjectsWithFieldSchemesResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBean2GetProjectsWithFieldSchemesResponse
