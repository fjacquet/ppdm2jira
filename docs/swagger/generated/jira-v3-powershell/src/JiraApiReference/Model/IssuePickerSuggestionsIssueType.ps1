...
function Initialize-IssuePickerSuggestionsIssueType {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssuePickerSuggestionsIssueType' | Write-Debug
...
function ConvertFrom-JsonToIssuePickerSuggestionsIssueType {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssuePickerSuggestionsIssueType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
