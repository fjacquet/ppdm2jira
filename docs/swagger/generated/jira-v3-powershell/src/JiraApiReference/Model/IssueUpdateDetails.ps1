...
function Initialize-IssueUpdateDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueUpdateDetails' | Write-Debug
...
function ConvertFrom-JsonToIssueUpdateDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueUpdateDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
