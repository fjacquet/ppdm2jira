...
function Initialize-JiraExpressionEvaluationMetaDataBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraExpressionEvaluationMetaDataBean' | Write-Debug
...
function ConvertFrom-JsonToJiraExpressionEvaluationMetaDataBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraExpressionEvaluationMetaDataBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
