...
function Initialize-ConnectWorkflowTransitionRule {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ConnectWorkflowTransitionRule' | Write-Debug
...
function ConvertFrom-JsonToConnectWorkflowTransitionRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ConnectWorkflowTransitionRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
