...
PriorityWithSequence<PSCustomObject>
#>

function Initialize-PriorityWithSequence {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PriorityWithSequence' | Write-Debug
...
Convert from JSON to PriorityWithSequence<PSCustomObject>
...
PriorityWithSequence<PSCustomObject>
#>
function ConvertFrom-JsonToPriorityWithSequence {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PriorityWithSequence' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PriorityWithSequence
        $AllProperties = ('description', 'iconUrl', 'id', 'isDefault', 'name', 'self', 'sequence', 'statusColor')
