...
function Initialize-ValidationOptionsForUpdate {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ValidationOptionsForUpdate' | Write-Debug
...
function ConvertFrom-JsonToValidationOptionsForUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ValidationOptionsForUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
