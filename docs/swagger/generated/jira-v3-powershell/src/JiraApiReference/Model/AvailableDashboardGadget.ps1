...
function Initialize-AvailableDashboardGadget {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AvailableDashboardGadget' | Write-Debug
...
function ConvertFrom-JsonToAvailableDashboardGadget {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AvailableDashboardGadget' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
