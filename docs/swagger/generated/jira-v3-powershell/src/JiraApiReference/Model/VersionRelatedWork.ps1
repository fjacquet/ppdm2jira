...
function Initialize-VersionRelatedWork {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => VersionRelatedWork' | Write-Debug
...
function ConvertFrom-JsonToVersionRelatedWork {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => VersionRelatedWork' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
