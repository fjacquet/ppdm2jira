...
function Initialize-MultipleCustomFieldValuesUpdate {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => MultipleCustomFieldValuesUpdate' | Write-Debug
...
function ConvertFrom-JsonToMultipleCustomFieldValuesUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => MultipleCustomFieldValuesUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
