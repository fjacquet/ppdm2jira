...
function Initialize-CustomFieldContextDefaultValueMultiUserPicker {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueMultiUserPicker' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldContextDefaultValueMultiUserPicker {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueMultiUserPicker' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
