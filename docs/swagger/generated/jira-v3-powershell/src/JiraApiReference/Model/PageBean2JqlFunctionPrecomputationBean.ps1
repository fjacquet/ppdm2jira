...
PageBean2JqlFunctionPrecomputationBean<PSCustomObject>
#>

function Initialize-PageBean2JqlFunctionPrecomputationBean {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBean2JqlFunctionPrecomputationBean' | Write-Debug
...
Convert from JSON to PageBean2JqlFunctionPrecomputationBean<PSCustomObject>
...
PageBean2JqlFunctionPrecomputationBean<PSCustomObject>
#>
function ConvertFrom-JsonToPageBean2JqlFunctionPrecomputationBean {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBean2JqlFunctionPrecomputationBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBean2JqlFunctionPrecomputationBean
