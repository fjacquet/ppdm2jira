...
PageBean2FieldAssociationSchemeProjectSearchResult<PSCustomObject>
#>

function Initialize-PageBean2FieldAssociationSchemeProjectSearchResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBean2FieldAssociationSchemeProjectSearchResult' | Write-Debug
...
Convert from JSON to PageBean2FieldAssociationSchemeProjectSearchResult<PSCustomObject>
...
PageBean2FieldAssociationSchemeProjectSearchResult<PSCustomObject>
#>
function ConvertFrom-JsonToPageBean2FieldAssociationSchemeProjectSearchResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBean2FieldAssociationSchemeProjectSearchResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBean2FieldAssociationSchemeProjectSearchResult
