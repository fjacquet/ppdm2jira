...
function Initialize-BulkProjectPermissions {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => BulkProjectPermissions' | Write-Debug
...
function ConvertFrom-JsonToBulkProjectPermissions {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => BulkProjectPermissions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
