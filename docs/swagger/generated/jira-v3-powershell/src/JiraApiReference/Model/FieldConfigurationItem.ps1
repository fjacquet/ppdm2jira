...
function Initialize-FieldConfigurationItem {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => FieldConfigurationItem' | Write-Debug
...
function ConvertFrom-JsonToFieldConfigurationItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => FieldConfigurationItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
