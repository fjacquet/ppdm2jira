...
function Initialize-PageOfCreateMetaIssueTypes {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageOfCreateMetaIssueTypes' | Write-Debug
...
function ConvertFrom-JsonToPageOfCreateMetaIssueTypes {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageOfCreateMetaIssueTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
