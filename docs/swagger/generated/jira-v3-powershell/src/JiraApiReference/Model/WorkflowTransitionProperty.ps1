...
function Initialize-WorkflowTransitionProperty {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowTransitionProperty' | Write-Debug
...
function ConvertFrom-JsonToWorkflowTransitionProperty {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowTransitionProperty' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
