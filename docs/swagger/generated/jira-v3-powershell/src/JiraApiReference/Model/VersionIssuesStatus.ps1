...
function Initialize-VersionIssuesStatus {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => VersionIssuesStatus' | Write-Debug
...
function ConvertFrom-JsonToVersionIssuesStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => VersionIssuesStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
