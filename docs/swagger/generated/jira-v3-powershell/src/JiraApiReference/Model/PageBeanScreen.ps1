...
PageBeanScreen<PSCustomObject>
#>

function Initialize-PageBeanScreen {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanScreen' | Write-Debug
...
Convert from JSON to PageBeanScreen<PSCustomObject>
...
PageBeanScreen<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanScreen {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanScreen' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanScreen
