...
PageBeanScreenWithTab<PSCustomObject>
#>

function Initialize-PageBeanScreenWithTab {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanScreenWithTab' | Write-Debug
...
Convert from JSON to PageBeanScreenWithTab<PSCustomObject>
...
PageBeanScreenWithTab<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanScreenWithTab {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanScreenWithTab' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanScreenWithTab
