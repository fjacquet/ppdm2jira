...
function Initialize-JQLQueryWithUnknownUsers {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JQLQueryWithUnknownUsers' | Write-Debug
...
function ConvertFrom-JsonToJQLQueryWithUnknownUsers {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JQLQueryWithUnknownUsers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
