...
function Initialize-WorkflowSchemeProjectAssociation {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowSchemeProjectAssociation' | Write-Debug
...
function ConvertFrom-JsonToWorkflowSchemeProjectAssociation {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowSchemeProjectAssociation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
