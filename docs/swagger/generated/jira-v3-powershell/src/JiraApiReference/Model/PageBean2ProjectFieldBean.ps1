...
PageBean2ProjectFieldBean<PSCustomObject>
#>

function Initialize-PageBean2ProjectFieldBean {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBean2ProjectFieldBean' | Write-Debug
...
Convert from JSON to PageBean2ProjectFieldBean<PSCustomObject>
...
PageBean2ProjectFieldBean<PSCustomObject>
#>
function ConvertFrom-JsonToPageBean2ProjectFieldBean {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBean2ProjectFieldBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBean2ProjectFieldBean
