...
function Initialize-JiraExpressionsComplexityValueBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraExpressionsComplexityValueBean' | Write-Debug
...
function ConvertFrom-JsonToJiraExpressionsComplexityValueBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraExpressionsComplexityValueBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
