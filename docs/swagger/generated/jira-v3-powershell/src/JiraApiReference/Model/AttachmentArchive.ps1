...
function Initialize-AttachmentArchive {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AttachmentArchive' | Write-Debug
...
function ConvertFrom-JsonToAttachmentArchive {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AttachmentArchive' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
