...
TaskProgressBeanJsonNode<PSCustomObject>
#>

function Initialize-TaskProgressBeanJsonNode {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => TaskProgressBeanJsonNode' | Write-Debug
...
Convert from JSON to TaskProgressBeanJsonNode<PSCustomObject>
...
TaskProgressBeanJsonNode<PSCustomObject>
#>
function ConvertFrom-JsonToTaskProgressBeanJsonNode {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => TaskProgressBeanJsonNode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaskProgressBeanJsonNode
