...
function Initialize-WorkflowCompoundCondition {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowCompoundCondition' | Write-Debug
...
function ConvertFrom-JsonToWorkflowCompoundCondition {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowCompoundCondition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
