...
PageBeanString<PSCustomObject>
#>

function Initialize-PageBeanString {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanString' | Write-Debug
...
Convert from JSON to PageBeanString<PSCustomObject>
...
PageBeanString<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanString {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanString' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanString
