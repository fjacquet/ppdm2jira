...
function Initialize-VersionUsageInCustomField {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => VersionUsageInCustomField' | Write-Debug
...
function ConvertFrom-JsonToVersionUsageInCustomField {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => VersionUsageInCustomField' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
