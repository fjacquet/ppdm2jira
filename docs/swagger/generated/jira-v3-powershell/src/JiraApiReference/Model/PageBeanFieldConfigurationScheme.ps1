...
PageBeanFieldConfigurationScheme<PSCustomObject>
#>

function Initialize-PageBeanFieldConfigurationScheme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanFieldConfigurationScheme' | Write-Debug
...
Convert from JSON to PageBeanFieldConfigurationScheme<PSCustomObject>
...
PageBeanFieldConfigurationScheme<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanFieldConfigurationScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanFieldConfigurationScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanFieldConfigurationScheme
