...
function Initialize-StatusesPerWorkflow {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => StatusesPerWorkflow' | Write-Debug
...
function ConvertFrom-JsonToStatusesPerWorkflow {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => StatusesPerWorkflow' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
