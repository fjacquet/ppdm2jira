...
function Initialize-IssueEntityPropertiesForMultiUpdate {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueEntityPropertiesForMultiUpdate' | Write-Debug
...
function ConvertFrom-JsonToIssueEntityPropertiesForMultiUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueEntityPropertiesForMultiUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
