...
PageBeanNotificationSchemeAndProjectMappingJsonBean<PSCustomObject>
#>

function Initialize-PageBeanNotificationSchemeAndProjectMappingJsonBean {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanNotificationSchemeAndProjectMappingJsonBean' | Write-Debug
...
Convert from JSON to PageBeanNotificationSchemeAndProjectMappingJsonBean<PSCustomObject>
...
PageBeanNotificationSchemeAndProjectMappingJsonBean<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanNotificationSchemeAndProjectMappingJsonBean {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanNotificationSchemeAndProjectMappingJsonBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanNotificationSchemeAndProjectMappingJsonBean
