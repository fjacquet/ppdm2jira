...
function Initialize-PageBeanFieldConfigurationIssueTypeItem {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanFieldConfigurationIssueTypeItem' | Write-Debug
...
function ConvertFrom-JsonToPageBeanFieldConfigurationIssueTypeItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanFieldConfigurationIssueTypeItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
