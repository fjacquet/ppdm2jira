...
function Initialize-JiraExpressionEvalRequestBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraExpressionEvalRequestBean' | Write-Debug
...
function ConvertFrom-JsonToJiraExpressionEvalRequestBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraExpressionEvalRequestBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
