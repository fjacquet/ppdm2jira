...
PageBeanContextForProjectAndIssueType<PSCustomObject>
#>

function Initialize-PageBeanContextForProjectAndIssueType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanContextForProjectAndIssueType' | Write-Debug
...
Convert from JSON to PageBeanContextForProjectAndIssueType<PSCustomObject>
...
PageBeanContextForProjectAndIssueType<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanContextForProjectAndIssueType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanContextForProjectAndIssueType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanContextForProjectAndIssueType
