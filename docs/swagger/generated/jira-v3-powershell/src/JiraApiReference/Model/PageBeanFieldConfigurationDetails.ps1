...
PageBeanFieldConfigurationDetails<PSCustomObject>
#>

function Initialize-PageBeanFieldConfigurationDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanFieldConfigurationDetails' | Write-Debug
...
Convert from JSON to PageBeanFieldConfigurationDetails<PSCustomObject>
...
PageBeanFieldConfigurationDetails<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanFieldConfigurationDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanFieldConfigurationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanFieldConfigurationDetails
