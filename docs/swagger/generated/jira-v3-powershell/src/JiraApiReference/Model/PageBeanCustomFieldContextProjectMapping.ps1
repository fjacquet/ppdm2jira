...
PageBeanCustomFieldContextProjectMapping<PSCustomObject>
#>

function Initialize-PageBeanCustomFieldContextProjectMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanCustomFieldContextProjectMapping' | Write-Debug
...
Convert from JSON to PageBeanCustomFieldContextProjectMapping<PSCustomObject>
...
PageBeanCustomFieldContextProjectMapping<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanCustomFieldContextProjectMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanCustomFieldContextProjectMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanCustomFieldContextProjectMapping
