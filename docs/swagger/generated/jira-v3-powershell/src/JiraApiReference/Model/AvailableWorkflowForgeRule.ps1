...
function Initialize-AvailableWorkflowForgeRule {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AvailableWorkflowForgeRule' | Write-Debug
...
function ConvertFrom-JsonToAvailableWorkflowForgeRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AvailableWorkflowForgeRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
