...
function Initialize-CustomFieldContextDefaultValueForgeUserField {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueForgeUserField' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldContextDefaultValueForgeUserField {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueForgeUserField' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
