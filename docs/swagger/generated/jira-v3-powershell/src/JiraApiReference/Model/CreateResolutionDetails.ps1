...
function Initialize-CreateResolutionDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CreateResolutionDetails' | Write-Debug
...
function ConvertFrom-JsonToCreateResolutionDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CreateResolutionDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
