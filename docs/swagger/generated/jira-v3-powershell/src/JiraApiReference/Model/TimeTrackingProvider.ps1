...
function Initialize-TimeTrackingProvider {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => TimeTrackingProvider' | Write-Debug
...
function ConvertFrom-JsonToTimeTrackingProvider {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => TimeTrackingProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
