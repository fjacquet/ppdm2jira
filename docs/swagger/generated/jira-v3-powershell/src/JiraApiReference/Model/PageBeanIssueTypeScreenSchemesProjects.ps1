...
PageBeanIssueTypeScreenSchemesProjects<PSCustomObject>
#>

function Initialize-PageBeanIssueTypeScreenSchemesProjects {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanIssueTypeScreenSchemesProjects' | Write-Debug
...
Convert from JSON to PageBeanIssueTypeScreenSchemesProjects<PSCustomObject>
...
PageBeanIssueTypeScreenSchemesProjects<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanIssueTypeScreenSchemesProjects {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanIssueTypeScreenSchemesProjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanIssueTypeScreenSchemesProjects
