...
function Initialize-IssueSecurityLevelMember {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueSecurityLevelMember' | Write-Debug
...
function ConvertFrom-JsonToIssueSecurityLevelMember {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueSecurityLevelMember' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IssueSecurityLevelMember
        $AllProperties = ('holder', 'id', 'issueSecurityLevelId')
