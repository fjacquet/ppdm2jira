...
PageBeanWorkflowTransitionRules<PSCustomObject>
#>

function Initialize-PageBeanWorkflowTransitionRules {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanWorkflowTransitionRules' | Write-Debug
...
Convert from JSON to PageBeanWorkflowTransitionRules<PSCustomObject>
...
PageBeanWorkflowTransitionRules<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanWorkflowTransitionRules {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanWorkflowTransitionRules' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanWorkflowTransitionRules
