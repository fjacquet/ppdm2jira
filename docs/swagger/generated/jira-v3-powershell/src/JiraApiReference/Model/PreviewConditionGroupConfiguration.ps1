...
PreviewConditionGroupConfiguration<PSCustomObject>
#>

function Initialize-PreviewConditionGroupConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PreviewConditionGroupConfiguration' | Write-Debug
...
Convert from JSON to PreviewConditionGroupConfiguration<PSCustomObject>
...
PreviewConditionGroupConfiguration<PSCustomObject>
#>
function ConvertFrom-JsonToPreviewConditionGroupConfiguration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PreviewConditionGroupConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PreviewConditionGroupConfiguration
