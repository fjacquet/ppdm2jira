...
function Initialize-WorkflowReadRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowReadRequest' | Write-Debug
...
function ConvertFrom-JsonToWorkflowReadRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowReadRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
