...
function Initialize-TimeTrackingConfiguration {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => TimeTrackingConfiguration' | Write-Debug
...
function ConvertFrom-JsonToTimeTrackingConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => TimeTrackingConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
