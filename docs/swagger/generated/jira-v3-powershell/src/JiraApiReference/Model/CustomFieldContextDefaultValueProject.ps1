...
function Initialize-CustomFieldContextDefaultValueProject {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueProject' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldContextDefaultValueProject {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueProject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
