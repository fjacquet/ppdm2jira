...
function Initialize-PermissionSchemes {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PermissionSchemes' | Write-Debug
...
function ConvertFrom-JsonToPermissionSchemes {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PermissionSchemes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
