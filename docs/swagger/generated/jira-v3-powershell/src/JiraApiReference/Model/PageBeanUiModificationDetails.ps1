...
PageBeanUiModificationDetails<PSCustomObject>
#>

function Initialize-PageBeanUiModificationDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanUiModificationDetails' | Write-Debug
...
Convert from JSON to PageBeanUiModificationDetails<PSCustomObject>
...
PageBeanUiModificationDetails<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanUiModificationDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanUiModificationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanUiModificationDetails
