...
function Initialize-ChangeFilterOwner {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ChangeFilterOwner' | Write-Debug
...
function ConvertFrom-JsonToChangeFilterOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ChangeFilterOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
