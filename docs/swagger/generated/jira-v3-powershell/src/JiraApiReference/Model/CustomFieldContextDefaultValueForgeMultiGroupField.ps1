...
CustomFieldContextDefaultValueForgeMultiGroupField<PSCustomObject>
#>

function Initialize-CustomFieldContextDefaultValueForgeMultiGroupField {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueForgeMultiGroupField' | Write-Debug
...
Convert from JSON to CustomFieldContextDefaultValueForgeMultiGroupField<PSCustomObject>
...
CustomFieldContextDefaultValueForgeMultiGroupField<PSCustomObject>
#>
function ConvertFrom-JsonToCustomFieldContextDefaultValueForgeMultiGroupField {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldContextDefaultValueForgeMultiGroupField' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CustomFieldContextDefaultValueForgeMultiGroupField
