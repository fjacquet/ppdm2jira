...
function Initialize-WorkflowRulesSearch {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowRulesSearch' | Write-Debug
...
function ConvertFrom-JsonToWorkflowRulesSearch {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowRulesSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
