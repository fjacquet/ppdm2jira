...
function Initialize-ConnectCustomFieldValue {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ConnectCustomFieldValue' | Write-Debug
...
function ConvertFrom-JsonToConnectCustomFieldValue {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ConnectCustomFieldValue' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
