...
PageBean2ComponentJsonBean<PSCustomObject>
#>

function Initialize-PageBean2ComponentJsonBean {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBean2ComponentJsonBean' | Write-Debug
...
Convert from JSON to PageBean2ComponentJsonBean<PSCustomObject>
...
PageBean2ComponentJsonBean<PSCustomObject>
#>
function ConvertFrom-JsonToPageBean2ComponentJsonBean {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBean2ComponentJsonBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBean2ComponentJsonBean
