...
function Initialize-JiraExpressionValidationError {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraExpressionValidationError' | Write-Debug
...
function ConvertFrom-JsonToJiraExpressionValidationError {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraExpressionValidationError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
