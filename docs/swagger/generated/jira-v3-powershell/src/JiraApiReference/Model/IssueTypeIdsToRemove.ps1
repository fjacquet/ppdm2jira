...
function Initialize-IssueTypeIdsToRemove {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeIdsToRemove' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeIdsToRemove {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeIdsToRemove' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
