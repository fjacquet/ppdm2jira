...
function Initialize-UpdateDefaultScreenScheme {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdateDefaultScreenScheme' | Write-Debug
...
function ConvertFrom-JsonToUpdateDefaultScreenScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdateDefaultScreenScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
