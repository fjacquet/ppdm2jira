...
function Initialize-UpdatePriorityDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdatePriorityDetails' | Write-Debug
...
function ConvertFrom-JsonToUpdatePriorityDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdatePriorityDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
