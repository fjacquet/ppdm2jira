...
PageBeanBulkContextualConfiguration<PSCustomObject>
#>

function Initialize-PageBeanBulkContextualConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanBulkContextualConfiguration' | Write-Debug
...
Convert from JSON to PageBeanBulkContextualConfiguration<PSCustomObject>
...
PageBeanBulkContextualConfiguration<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanBulkContextualConfiguration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanBulkContextualConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanBulkContextualConfiguration
