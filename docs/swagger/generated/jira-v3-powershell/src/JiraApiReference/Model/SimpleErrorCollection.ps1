...
function Initialize-SimpleErrorCollection {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => SimpleErrorCollection' | Write-Debug
...
function ConvertFrom-JsonToSimpleErrorCollection {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => SimpleErrorCollection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
