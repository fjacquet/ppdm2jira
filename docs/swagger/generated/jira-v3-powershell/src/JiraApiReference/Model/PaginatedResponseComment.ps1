...
function Initialize-PaginatedResponseComment {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PaginatedResponseComment' | Write-Debug
...
function ConvertFrom-JsonToPaginatedResponseComment {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PaginatedResponseComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
