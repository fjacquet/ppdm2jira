...
function Initialize-IssueTypeSchemeDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueTypeSchemeDetails' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeSchemeDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueTypeSchemeDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
