...
function Initialize-UpdateResolutionDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdateResolutionDetails' | Write-Debug
...
function ConvertFrom-JsonToUpdateResolutionDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdateResolutionDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
