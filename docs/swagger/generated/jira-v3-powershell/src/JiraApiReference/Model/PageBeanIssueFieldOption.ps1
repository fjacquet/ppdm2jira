...
PageBeanIssueFieldOption<PSCustomObject>
#>

function Initialize-PageBeanIssueFieldOption {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanIssueFieldOption' | Write-Debug
...
Convert from JSON to PageBeanIssueFieldOption<PSCustomObject>
...
PageBeanIssueFieldOption<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanIssueFieldOption {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanIssueFieldOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanIssueFieldOption
