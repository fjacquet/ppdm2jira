...
function Initialize-JiraExpressionForAnalysis {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => JiraExpressionForAnalysis' | Write-Debug
...
function ConvertFrom-JsonToJiraExpressionForAnalysis {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => JiraExpressionForAnalysis' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JiraExpressionForAnalysis
        $AllProperties = ('contextVariables', 'expressions')
