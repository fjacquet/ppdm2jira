...
function Initialize-ProjectRoleActorsUpdateBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ProjectRoleActorsUpdateBean' | Write-Debug
...
function ConvertFrom-JsonToProjectRoleActorsUpdateBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ProjectRoleActorsUpdateBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
