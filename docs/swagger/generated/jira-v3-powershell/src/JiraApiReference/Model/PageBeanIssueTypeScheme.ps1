...
PageBeanIssueTypeScheme<PSCustomObject>
#>

function Initialize-PageBeanIssueTypeScheme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanIssueTypeScheme' | Write-Debug
...
Convert from JSON to PageBeanIssueTypeScheme<PSCustomObject>
...
PageBeanIssueTypeScheme<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanIssueTypeScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanIssueTypeScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanIssueTypeScheme
