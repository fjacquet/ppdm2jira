...
function Initialize-Field {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => Field' | Write-Debug
...
function ConvertFrom-JsonToField {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => Field' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Field
        $AllProperties = ('contextsCount', 'description', 'id', 'isLocked', 'isUnscreenable', 'key', 'lastUsed', 'name', 'projectsCount', 'schema', 'screensCount', 'searcherKey', 'stableId', 'typeDisplayName')
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match 'stableId'))) { #optional property not found
            $StableId = $null
        } else {
            $StableId = $JsonParameters.PSobject.Properties['stableId'].value
        }
