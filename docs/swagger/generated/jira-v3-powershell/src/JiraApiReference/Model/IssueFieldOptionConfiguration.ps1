...
function Initialize-IssueFieldOptionConfiguration {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueFieldOptionConfiguration' | Write-Debug
...
function ConvertFrom-JsonToIssueFieldOptionConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueFieldOptionConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
