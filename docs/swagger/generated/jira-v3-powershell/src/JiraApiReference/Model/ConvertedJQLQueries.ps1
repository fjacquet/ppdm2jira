...
function Initialize-ConvertedJQLQueries {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ConvertedJQLQueries' | Write-Debug
...
function ConvertFrom-JsonToConvertedJQLQueries {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ConvertedJQLQueries' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
