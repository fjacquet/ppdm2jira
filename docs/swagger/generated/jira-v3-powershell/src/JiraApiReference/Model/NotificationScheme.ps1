...
function Initialize-NotificationScheme {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => NotificationScheme' | Write-Debug
...
function ConvertFrom-JsonToNotificationScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => NotificationScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
