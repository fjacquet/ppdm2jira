...
ReorderIssuePriorities<PSCustomObject>
#>

function Initialize-ReorderIssuePriorities {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ReorderIssuePriorities' | Write-Debug
...
Convert from JSON to ReorderIssuePriorities<PSCustomObject>
...
ReorderIssuePriorities<PSCustomObject>
#>
function ConvertFrom-JsonToReorderIssuePriorities {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ReorderIssuePriorities' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ReorderIssuePriorities
