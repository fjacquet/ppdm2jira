...
function Initialize-ReorderIssueResolutionsRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ReorderIssueResolutionsRequest' | Write-Debug
...
function ConvertFrom-JsonToReorderIssueResolutionsRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ReorderIssueResolutionsRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
