...
function Initialize-BulkProjectPermissionGrants {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => BulkProjectPermissionGrants' | Write-Debug
...
function ConvertFrom-JsonToBulkProjectPermissionGrants {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => BulkProjectPermissionGrants' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
