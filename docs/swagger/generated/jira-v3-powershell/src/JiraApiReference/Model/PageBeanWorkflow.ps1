...
PageBeanWorkflow<PSCustomObject>
#>

function Initialize-PageBeanWorkflow {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanWorkflow' | Write-Debug
...
Convert from JSON to PageBeanWorkflow<PSCustomObject>
...
PageBeanWorkflow<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanWorkflow {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanWorkflow' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanWorkflow
