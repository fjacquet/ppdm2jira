...
function Initialize-IssueFilterForBulkPropertyDelete {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => IssueFilterForBulkPropertyDelete' | Write-Debug
...
function ConvertFrom-JsonToIssueFilterForBulkPropertyDelete {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => IssueFilterForBulkPropertyDelete' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
