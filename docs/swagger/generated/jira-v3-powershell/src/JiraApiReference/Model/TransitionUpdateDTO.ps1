...
function Initialize-TransitionUpdateDTO {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => TransitionUpdateDTO' | Write-Debug
...
function ConvertFrom-JsonToTransitionUpdateDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => TransitionUpdateDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
