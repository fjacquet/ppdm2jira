...
function Initialize-ConnectCustomFieldValues {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => ConnectCustomFieldValues' | Write-Debug
...
function ConvertFrom-JsonToConnectCustomFieldValues {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => ConnectCustomFieldValues' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
