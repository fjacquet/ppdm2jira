...
function Initialize-StatusUpdateRequest {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => StatusUpdateRequest' | Write-Debug
...
function ConvertFrom-JsonToStatusUpdateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => StatusUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
