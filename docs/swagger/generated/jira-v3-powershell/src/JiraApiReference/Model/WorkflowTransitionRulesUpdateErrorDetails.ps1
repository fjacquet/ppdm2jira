...
function Initialize-WorkflowTransitionRulesUpdateErrorDetails {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => WorkflowTransitionRulesUpdateErrorDetails' | Write-Debug
...
function ConvertFrom-JsonToWorkflowTransitionRulesUpdateErrorDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => WorkflowTransitionRulesUpdateErrorDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
