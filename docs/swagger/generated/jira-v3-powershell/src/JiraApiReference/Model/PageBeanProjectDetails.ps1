...
PageBeanProjectDetails<PSCustomObject>
#>

function Initialize-PageBeanProjectDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanProjectDetails' | Write-Debug
...
Convert from JSON to PageBeanProjectDetails<PSCustomObject>
...
PageBeanProjectDetails<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanProjectDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanProjectDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanProjectDetails
