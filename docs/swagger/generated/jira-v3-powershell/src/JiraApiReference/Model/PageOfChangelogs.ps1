...
PageOfChangelogs<PSCustomObject>
#>

function Initialize-PageOfChangelogs {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageOfChangelogs' | Write-Debug
...
Convert from JSON to PageOfChangelogs<PSCustomObject>
...
PageOfChangelogs<PSCustomObject>
#>
function ConvertFrom-JsonToPageOfChangelogs {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageOfChangelogs' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageOfChangelogs
