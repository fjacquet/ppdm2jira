...
function Initialize-CustomFieldDefinitionJsonBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => CustomFieldDefinitionJsonBean' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldDefinitionJsonBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => CustomFieldDefinitionJsonBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
