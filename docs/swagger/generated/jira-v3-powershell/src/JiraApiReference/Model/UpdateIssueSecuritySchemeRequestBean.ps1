...
function Initialize-UpdateIssueSecuritySchemeRequestBean {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => UpdateIssueSecuritySchemeRequestBean' | Write-Debug
...
function ConvertFrom-JsonToUpdateIssueSecuritySchemeRequestBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => UpdateIssueSecuritySchemeRequestBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
