...
PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects<PSCustomObject>
#>

function Initialize-PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects' | Write-Debug
...
Convert from JSON to PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects<PSCustomObject>
...
PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects
