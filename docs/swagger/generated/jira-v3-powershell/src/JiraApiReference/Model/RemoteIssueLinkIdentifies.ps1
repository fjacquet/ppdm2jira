...
function Initialize-RemoteIssueLinkIdentifies {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => RemoteIssueLinkIdentifies' | Write-Debug
...
function ConvertFrom-JsonToRemoteIssueLinkIdentifies {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => RemoteIssueLinkIdentifies' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
