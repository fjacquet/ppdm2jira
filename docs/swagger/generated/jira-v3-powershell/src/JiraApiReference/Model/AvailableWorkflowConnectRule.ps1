...
function Initialize-AvailableWorkflowConnectRule {
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => AvailableWorkflowConnectRule' | Write-Debug
...
function ConvertFrom-JsonToAvailableWorkflowConnectRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => AvailableWorkflowConnectRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
