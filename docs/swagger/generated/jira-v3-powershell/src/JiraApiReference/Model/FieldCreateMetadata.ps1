...
FieldCreateMetadata<PSCustomObject>
#>

function Initialize-FieldCreateMetadata {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: JiraApiReference => FieldCreateMetadata' | Write-Debug
...
Convert from JSON to FieldCreateMetadata<PSCustomObject>
...
FieldCreateMetadata<PSCustomObject>
#>
function ConvertFrom-JsonToFieldCreateMetadata {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: JiraApiReference => FieldCreateMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FieldCreateMetadata
        $AllProperties = ('allowedValues', 'autoCompleteUrl', 'configuration', 'defaultValue', 'fieldId', 'hasDefaultValue', 'key', 'name', 'operations', 'required', 'schema')
