...
None
#>
function Invoke-BulkDeleteWorklogs {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-BulkDeleteWorklogs' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/rest/api/3/issue/{issueIdOrKey}/worklog'
        if (!$IssueIdOrKey) {
            throw "Error! The required parameter `IssueIdOrKey` missing when calling bulkDeleteWorklogs."
        }
        $LocalVarUri = $LocalVarUri.replace('{issueIdOrKey}', [System.Web.HTTPUtility]::UrlEncode($IssueIdOrKey))
        ...
        if (!$WorklogIdsRequestBean) {
            throw "Error! The required parameter `WorklogIdsRequestBean` missing when calling bulkDeleteWorklogs."
        }
...
.PARAMETER WorklogsMoveRequestBean
...
None
#>
function Invoke-BulkMoveWorklogs {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-BulkMoveWorklogs' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/rest/api/3/issue/{issueIdOrKey}/worklog/move'
        if (!$IssueIdOrKey) {
            throw "Error! The required parameter `IssueIdOrKey` missing when calling bulkMoveWorklogs."
        }
        $LocalVarUri = $LocalVarUri.replace('{issueIdOrKey}', [System.Web.HTTPUtility]::UrlEncode($IssueIdOrKey))
        ...
        if (!$WorklogsMoveRequestBean) {
            throw "Error! The required parameter `WorklogsMoveRequestBean` missing when calling bulkMoveWorklogs."
        }

        $LocalVarBodyParameter = $WorklogsMoveRequestBean | ConvertTo-Json -Depth 100
