...
.PARAMETER BulkFetchIssueRequestBean
...
BulkIssueResults
#>
function Invoke-BulkFetchIssues {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-BulkFetchIssues' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/rest/api/3/issue/bulkfetch'

        if (!$BulkFetchIssueRequestBean) {
            throw "Error! The required parameter `BulkFetchIssueRequestBean` missing when calling bulkFetchIssues."
        }

        $LocalVarBodyParameter = $BulkFetchIssueRequestBean | ConvertTo-Json -Depth 100
...
.PARAMETER BulkChangelogRequestBean
...
function Get-BulkChangelogs {
    ...
    Process {
        'Calling method: Get-BulkChangelogs' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/rest/api/3/changelog/bulkfetch'

        if (!$BulkChangelogRequestBean) {
            throw "Error! The required parameter `BulkChangelogRequestBean` missing when calling getBulkChangelogs."
        }

        $LocalVarBodyParameter = $BulkChangelogRequestBean | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "BulkChangelogResponseBean" `
                                -IsBodyNullable $false
...
function Get-IssueLimitReport {
    ...
    Process {
        'Calling method: Get-IssueLimitReport' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/rest/api/3/issue/limit/report'

        if ($IsReturningKeys) {
            $LocalVarQueryParameters['isReturningKeys'] = $IsReturningKeys
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "IssueLimitReportResponseBean" `
                                -IsBodyNullable $false
