...
.PARAMETER ConfigurationsListParameters
No description available.
...
#>
function Get-CustomFieldsConfigurations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Get-CustomFieldsConfigurations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/rest/api/3/app/field/context/configuration/list'
        ...
        if (!$ConfigurationsListParameters) {
            throw "Error! The required parameter `ConfigurationsListParameters` missing when calling getCustomFieldsConfigurations."
        }

        $LocalVarBodyParameter = $ConfigurationsListParameters | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "PageBeanBulkContextualConfiguration" `
                                -IsBodyNullable $false
