...
function Get-RemoteIssueLinks {
    ...
    Process {
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "GetRemoteIssueLinks200Response" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-JsonToGetRemoteIssueLinks200Response (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
