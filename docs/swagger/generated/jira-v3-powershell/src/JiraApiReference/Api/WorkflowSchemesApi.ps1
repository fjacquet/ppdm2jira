...
#>
function Get-ProjectUsagesForWorkflowScheme {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-ProjectUsagesForWorkflowScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/rest/api/3/workflowscheme/{workflowSchemeId}/projectUsages'
        if (!$WorkflowSchemeId) {
            throw "Error! The required parameter `WorkflowSchemeId` missing when calling getProjectUsagesForWorkflowScheme."
        }
        $LocalVarUri = $LocalVarUri.replace('{workflowSchemeId}', [System.Web.HTTPUtility]::UrlEncode($WorkflowSchemeId))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "WorkflowSchemeProjectUsageDTO" `
                                -IsBodyNullable $false
...
#>
function Get-RequiredWorkflowSchemeMappings {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Get-RequiredWorkflowSchemeMappings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$WorkflowSchemeUpdateRequiredMappingsRequest) {
            throw "Error! The required parameter `WorkflowSchemeUpdateRequiredMappingsRequest` missing when calling getRequiredWorkflowSchemeMappings."
        }
...
.PARAMETER WorkflowSchemeProjectSwitchBean
...
None
#>
function Switch-WorkflowSchemeForProject {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Switch-WorkflowSchemeForProject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/rest/api/3/workflowscheme/project/switch'

        if (!$WorkflowSchemeProjectSwitchBean) {
            throw "Error! The required parameter `WorkflowSchemeProjectSwitchBean` missing when calling switchWorkflowSchemeForProject."
        }

        $LocalVarBodyParameter = $WorkflowSchemeProjectSwitchBean | ConvertTo-Json -Depth 100
