...
**Values** | [**FieldAssociationSchemeProjectSearchResult[]**](FieldAssociationSchemeProjectSearchResult.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBean2FieldAssociationSchemeProjectSearchResult = Initialize-JiraApiReferencePageBean2FieldAssociationSchemeProjectSearchResult  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBean2FieldAssociationSchemeProjectSearchResult | ConvertTo-JSON
```
