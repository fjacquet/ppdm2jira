...
```powershell
$JiraExpressionEvaluateContextBean = Initialize-JiraApiReferenceJiraExpressionEvaluateContextBean  -Board null `
 -Custom null `
...
```powershell
$JiraExpressionEvaluateContextBean | ConvertTo-JSON
```
