...
**Values** | [**Dashboard[]**](Dashboard.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanDashboard = Initialize-JiraApiReferencePageBeanDashboard  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanDashboard | ConvertTo-JSON
```
