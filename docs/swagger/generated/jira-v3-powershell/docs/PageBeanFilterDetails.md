...
**Values** | [**FilterDetails[]**](FilterDetails.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanFilterDetails = Initialize-JiraApiReferencePageBeanFilterDetails  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanFilterDetails | ConvertTo-JSON
```
