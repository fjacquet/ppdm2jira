...
**Values** | [**CustomFieldContextDefaultValue[]**](CustomFieldContextDefaultValue.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanCustomFieldContextDefaultValue = Initialize-JiraApiReferencePageBeanCustomFieldContextDefaultValue  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanCustomFieldContextDefaultValue | ConvertTo-JSON
```
