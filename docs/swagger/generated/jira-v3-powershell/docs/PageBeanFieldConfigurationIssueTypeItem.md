...
**Values** | [**FieldConfigurationIssueTypeItem[]**](FieldConfigurationIssueTypeItem.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanFieldConfigurationIssueTypeItem = Initialize-JiraApiReferencePageBeanFieldConfigurationIssueTypeItem  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanFieldConfigurationIssueTypeItem | ConvertTo-JSON
```
