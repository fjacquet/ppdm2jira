...
**Values** | [**ComponentJsonBean[]**](ComponentJsonBean.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBean2ComponentJsonBean = Initialize-JiraApiReferencePageBean2ComponentJsonBean  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBean2ComponentJsonBean | ConvertTo-JSON
```
