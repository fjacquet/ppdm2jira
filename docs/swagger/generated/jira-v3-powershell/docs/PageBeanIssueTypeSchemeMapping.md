...
**Values** | [**IssueTypeSchemeMapping[]**](IssueTypeSchemeMapping.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanIssueTypeSchemeMapping = Initialize-JiraApiReferencePageBeanIssueTypeSchemeMapping  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanIssueTypeSchemeMapping | ConvertTo-JSON
```
