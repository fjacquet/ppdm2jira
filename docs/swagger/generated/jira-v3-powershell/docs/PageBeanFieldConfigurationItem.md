...
**Values** | [**FieldConfigurationItem[]**](FieldConfigurationItem.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanFieldConfigurationItem = Initialize-JiraApiReferencePageBeanFieldConfigurationItem  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanFieldConfigurationItem | ConvertTo-JSON
```
