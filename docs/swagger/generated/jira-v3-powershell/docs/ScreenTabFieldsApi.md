# JiraApiReference.JiraApiReference\Api.ScreenTabFieldsApi
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SkipFieldAssociation] <System.Nullable[Boolean]><br>
...
$SkipFieldAssociation = $true # Boolean |  (optional) (default to $false)

# Add screen tab field
try {
    $Result = Add-ScreenTabField -ScreenId $ScreenId -TabId $TabId -AddFieldBean $AddFieldBean -SkipFieldAssociation $SkipFieldAssociation
} catch {
 ...
 **SkipFieldAssociation** | **Boolean**|  | [optional] [default to $false]
