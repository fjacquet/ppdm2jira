# JiraApiReference.JiraApiReference\Api.WorkflowSchemesApi
...
[**Get-ProjectUsagesForWorkflowScheme**](WorkflowSchemesApi.md#Get-ProjectUsagesForWorkflowScheme) | **GET** /rest/api/3/workflowscheme/{workflowSchemeId}/projectUsages | Get projects which are using a given workflow scheme
[**Get-RequiredWorkflowSchemeMappings**](WorkflowSchemesApi.md#Get-RequiredWorkflowSchemeMappings) | **POST** /rest/api/3/workflowscheme/update/mappings | Get required status mappings for workflow scheme update
...
[**Switch-WorkflowSchemeForProject**](WorkflowSchemesApi.md#Switch-WorkflowSchemeForProject) | **POST** /rest/api/3/workflowscheme/project/switch | Switch workflow scheme for project
...
<a id="Get-ProjectUsagesForWorkflowScheme"></a>
# **Get-ProjectUsagesForWorkflowScheme**
> WorkflowSchemeProjectUsageDTO Get-ProjectUsagesForWorkflowScheme<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowSchemeId] <String><br>
...
$WorkflowSchemeId = "MyWorkflowSchemeId" # String | The workflow scheme ID
...
# Get projects which are using a given workflow scheme
try {
    $Result = Get-ProjectUsagesForWorkflowScheme -WorkflowSchemeId $WorkflowSchemeId -NextPageToken $NextPageToken -MaxResults $MaxResults
} catch {
    Write-Host ("Exception occurred when calling Get-ProjectUsagesForWorkflowScheme: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**WorkflowSchemeProjectUsageDTO**](WorkflowSchemeProjectUsageDTO.md) (PSCustomObject)
...
<a id="Get-RequiredWorkflowSchemeMappings"></a>
# **Get-RequiredWorkflowSchemeMappings**
> WorkflowSchemeUpdateRequiredMappingsResponse Get-RequiredWorkflowSchemeMappings<br>
...
# Get required status mappings for workflow scheme update
try {
    $Result = Get-RequiredWorkflowSchemeMappings -WorkflowSchemeUpdateRequiredMappingsRequest $WorkflowSchemeUpdateRequiredMappingsRequest
} catch {
    Write-Host ("Exception occurred when calling Get-RequiredWorkflowSchemeMappings: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Bulk get workflow schemes
try {
    $Result = Read-WorkflowSchemes -WorkflowSchemeReadRequest $WorkflowSchemeReadRequest
} catch {
...
<a id="Switch-WorkflowSchemeForProject"></a>
# **Switch-WorkflowSchemeForProject**
> void Switch-WorkflowSchemeForProject<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowSchemeProjectSwitchBean] <PSCustomObject><br>
...
$WorkflowSchemeProjectSwitchBean = Initialize-WorkflowSchemeProjectSwitchBean -MappingsByIssueTypeOverride $MappingsByIssueTypeOverride -ProjectId "10001" -TargetSchemeId "10002" # WorkflowSchemeProjectSwitchBean | The request containing project ID, target scheme ID, and any issue type mappings.

# Switch workflow scheme for project
try {
    $Result = Switch-WorkflowSchemeForProject -WorkflowSchemeProjectSwitchBean $WorkflowSchemeProjectSwitchBean
} catch {
    Write-Host ("Exception occurred when calling Switch-WorkflowSchemeForProject: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
