...
**Values** | [**IssueTypeSchemeProjects[]**](IssueTypeSchemeProjects.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanIssueTypeSchemeProjects = Initialize-JiraApiReferencePageBeanIssueTypeSchemeProjects  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanIssueTypeSchemeProjects | ConvertTo-JSON
```
