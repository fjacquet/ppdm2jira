...
**Values** | [**IssueSecuritySchemeToProjectMapping[]**](IssueSecuritySchemeToProjectMapping.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanIssueSecuritySchemeToProjectMapping = Initialize-JiraApiReferencePageBeanIssueSecuritySchemeToProjectMapping  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanIssueSecuritySchemeToProjectMapping | ConvertTo-JSON
```
