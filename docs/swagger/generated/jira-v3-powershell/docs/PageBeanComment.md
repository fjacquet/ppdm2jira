...
**Values** | [**Comment[]**](Comment.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanComment = Initialize-JiraApiReferencePageBeanComment  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanComment | ConvertTo-JSON
```
