...
**Values** | [**SecurityLevelMember[]**](SecurityLevelMember.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanSecurityLevelMember = Initialize-JiraApiReferencePageBeanSecurityLevelMember  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanSecurityLevelMember | ConvertTo-JSON
```
