# JiraApiReference.JiraApiReference\Api.UsersApi
...
$MaxResults = 56 # Int32 | The maximum number of items to return (limited to 1000). (optional) (default to 50)
$Expand = "MyExpand" # String |  (optional)

# Get all users
try {
    $Result = Get-AllUsers -StartAt $StartAt -MaxResults $MaxResults -Expand $Expand
} catch {
 ...
 **MaxResults** | **Int32**| The maximum number of items to return (limited to 1000). | [optional] [default to 50]
...
# Get all users default
try {
    $Result = Get-AllUsersDefault -StartAt $StartAt -MaxResults $MaxResults -Expand $Expand
} catch {
