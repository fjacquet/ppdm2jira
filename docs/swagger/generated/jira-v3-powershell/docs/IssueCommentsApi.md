# JiraApiReference.JiraApiReference\Api.IssueCommentsApi
...
$Comment = Initialize-Comment -Author $UserDetails -Body  -Created (Get-Date) -Id "MyId" -JsdAuthorCanSeeRequest $false -JsdPublic $false -Properties $EntityProperty -RenderedBody "MyRenderedBody" -Self "MySelf" -UpdateAuthor $UserDetails -Updated (Get-Date) -Visibility # Comment | 
