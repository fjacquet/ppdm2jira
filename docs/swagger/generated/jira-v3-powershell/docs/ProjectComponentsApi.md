# JiraApiReference.JiraApiReference\Api.ProjectComponentsApi
...
$ProjectIdsOrKeys = "MyProjectIdsOrKeys" # String[] | The project IDs and/or project keys (case sensitive). (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ProjectIdsOrKeys** | [**String[]**](String.md)| The project IDs and/or project keys (case sensitive). | [optional] 
