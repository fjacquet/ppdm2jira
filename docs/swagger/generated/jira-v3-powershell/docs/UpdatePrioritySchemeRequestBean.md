...
------------ | ------------- | ------------- | -------------
**DefaultPriorityId** | **Int64** | The default priority of the scheme. | [optional] 
...
**Priorities** | [**UpdatePrioritiesInSchemeRequestBean**](UpdatePrioritiesInSchemeRequestBean.md) | The priorities in the scheme. | [optional] 
**Projects** | [**UpdateProjectsInSchemeRequestBean**](UpdateProjectsInSchemeRequestBean.md) | The projects in the scheme. | [optional] 

## Examples

- Prepare the resource
```powershell
$UpdatePrioritySchemeRequestBean = Initialize-JiraApiReferenceUpdatePrioritySchemeRequestBean  -DefaultPriorityId null `
 -Description null `
 -Mappings null `
 -Name null `
 -Priorities null `
...
```powershell
$UpdatePrioritySchemeRequestBean | ConvertTo-JSON
```
