...
```powershell
$PageBeanCustomFieldContextProjectMapping = Initialize-JiraApiReferencePageBeanCustomFieldContextProjectMapping  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanCustomFieldContextProjectMapping | ConvertTo-JSON
```
