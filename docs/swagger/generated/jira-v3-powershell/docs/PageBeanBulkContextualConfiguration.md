...
**Values** | [**BulkContextualConfiguration[]**](BulkContextualConfiguration.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanBulkContextualConfiguration = Initialize-JiraApiReferencePageBeanBulkContextualConfiguration  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanBulkContextualConfiguration | ConvertTo-JSON
```
