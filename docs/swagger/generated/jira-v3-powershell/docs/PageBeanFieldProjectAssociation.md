...
**Values** | [**FieldProjectAssociation[]**](FieldProjectAssociation.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanFieldProjectAssociation = Initialize-JiraApiReferencePageBeanFieldProjectAssociation  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanFieldProjectAssociation | ConvertTo-JSON
```
