...
**Values** | [**ContextForProjectAndIssueType[]**](ContextForProjectAndIssueType.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanContextForProjectAndIssueType = Initialize-JiraApiReferencePageBeanContextForProjectAndIssueType  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanContextForProjectAndIssueType | ConvertTo-JSON
```
