...
```powershell
$PageBeanIssueTypeToContextMapping = Initialize-JiraApiReferencePageBeanIssueTypeToContextMapping  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanIssueTypeToContextMapping | ConvertTo-JSON
```
