# JiraApiReference.JiraApiReference\Api.UserSearchApi
...
$Project = "MyProject" # String | The project ID or project key (case sensitive). Required, unless `issueKey` or `issueId` is specified. (optional)
$IssueKey = "MyIssueKey" # String | The key of the issue. Required, unless `issueId` or `project` is specified. (optional)
$IssueId = "MyIssueId" # String | The ID of the issue. Required, unless `issueKey` or `project` is specified. (optional)
...
$AccountType = "MyAccountType" # String[] |  (optional)
$AppType = "MyAppType" # String[] |  (optional)

# Find users assignable to issues
try {
    $Result = Find-AssignableUsers -Query $Query -SessionId $SessionId -Username $Username -AccountId $AccountId -Project $Project -IssueKey $IssueKey -IssueId $IssueId -StartAt $StartAt -MaxResults $MaxResults -ActionDescriptorId $ActionDescriptorId -Recommend $Recommend -AccountType $AccountType -AppType $AppType
} catch {
 ...
 **AccountType** | [**String[]**](String.md)|  | [optional] 
 **AppType** | [**String[]**](String.md)|  | [optional] 
