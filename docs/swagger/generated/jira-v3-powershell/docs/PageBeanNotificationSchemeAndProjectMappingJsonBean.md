...
**Values** | [**NotificationSchemeAndProjectMappingJsonBean[]**](NotificationSchemeAndProjectMappingJsonBean.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanNotificationSchemeAndProjectMappingJsonBean = Initialize-JiraApiReferencePageBeanNotificationSchemeAndProjectMappingJsonBean  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanNotificationSchemeAndProjectMappingJsonBean | ConvertTo-JSON
```
