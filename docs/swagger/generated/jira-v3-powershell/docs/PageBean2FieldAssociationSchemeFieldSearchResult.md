...
**Values** | [**FieldAssociationSchemeFieldSearchResult[]**](FieldAssociationSchemeFieldSearchResult.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBean2FieldAssociationSchemeFieldSearchResult = Initialize-JiraApiReferencePageBean2FieldAssociationSchemeFieldSearchResult  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBean2FieldAssociationSchemeFieldSearchResult | ConvertTo-JSON
```
