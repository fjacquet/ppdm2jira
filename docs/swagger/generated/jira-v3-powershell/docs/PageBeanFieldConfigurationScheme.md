...
**Values** | [**FieldConfigurationScheme[]**](FieldConfigurationScheme.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanFieldConfigurationScheme = Initialize-JiraApiReferencePageBeanFieldConfigurationScheme  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanFieldConfigurationScheme | ConvertTo-JSON
```
