...
**GuidelineADF** | **String** | The guideline in ADF (Atlassian Document Format) for rich text rendering. | [optional] 
...
```powershell
$DataClassificationTagBean = Initialize-JiraApiReferenceDataClassificationTagBean  -Color null `
 -Description null `
 -Guideline null `
 -GuidelineADF null `
 -Id null `
