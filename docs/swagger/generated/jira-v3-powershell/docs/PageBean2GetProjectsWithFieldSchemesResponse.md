...
**Values** | [**GetProjectsWithFieldSchemesResponse[]**](GetProjectsWithFieldSchemesResponse.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBean2GetProjectsWithFieldSchemesResponse = Initialize-JiraApiReferencePageBean2GetProjectsWithFieldSchemesResponse  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBean2GetProjectsWithFieldSchemesResponse | ConvertTo-JSON
```
