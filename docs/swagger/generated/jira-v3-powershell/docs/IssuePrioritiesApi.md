# JiraApiReference.JiraApiReference\Api.IssuePrioritiesApi
...
$CreatePriorityDetails = Initialize-CreatePriorityDetails -AvatarId 0 -Description "MyDescription" -IconUrl "/images/icons/priorities/blocker.png" -Name "MyName" -StatusColor "MyStatusColor" # CreatePriorityDetails | 
...
# Delete priority
try {
    $Result = Invoke-DeletePriority -Id $Id
} catch {
...
$Expand = "MyExpand" # String | Use `schemes` to return the associated priority schemes for each priority. Limited to returning first 15 priority schemes per priority. (optional) (default to "")

# Search priorities
try {
    $Result = Search-Priorities -StartAt $StartAt -MaxResults $MaxResults -Id $Id -ProjectId $ProjectId -PriorityName $PriorityName -OnlyDefault $OnlyDefault -Expand $Expand
} catch {
...
$Id = "MyId" # String | The ID of the issue priority.
$UpdatePriorityDetails = Initialize-UpdatePriorityDetails -AvatarId 0 -Description "MyDescription" -IconUrl "/images/icons/priorities/blocker.png" -Name "MyName" -StatusColor "MyStatusColor" # UpdatePriorityDetails | 
