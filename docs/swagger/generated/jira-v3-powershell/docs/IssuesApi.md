# JiraApiReference.JiraApiReference\Api.IssuesApi
...
[**Invoke-BulkFetchIssues**](IssuesApi.md#Invoke-BulkFetchIssues) | **POST** /rest/api/3/issue/bulkfetch | Bulk fetch issues
...
[**Get-BulkChangelogs**](IssuesApi.md#Get-BulkChangelogs) | **POST** /rest/api/3/changelog/bulkfetch | Bulk fetch changelogs
...
[**Get-IssueLimitReport**](IssuesApi.md#Get-IssueLimitReport) | **GET** /rest/api/3/issue/limit/report | Get issue limit report
...
$SimpleListWrapperApplicationRole = Initialize-SimpleListWrapperApplicationRole -Callback  -Items $ApplicationRole -MaxResults 0 -PagingCallback  -Size 0

$AvatarUrlsBean = Initialize-AvatarUrlsBean -Var16x16 "MyVar16x16" -Var24x24 "MyVar24x24" -Var32x32 "MyVar32x32" -Var48x48 "MyVar48x48"

$SimpleListWrapperGroupName = Initialize-SimpleListWrapperGroupName -Callback  -Items $GroupName -MaxResults 0 -PagingCallback  -Size 0

$User = Initialize-User -AccountId "MyAccountId" -AccountType "atlassian" -Active $false -AppType "MyAppType" -ApplicationRoles $SimpleListWrapperApplicationRole -AvatarUrls $AvatarUrlsBean -DisplayName "MyDisplayName" -EmailAddress "MyEmailAddress" -Expand "MyExpand" -Groups $SimpleListWrapperGroupName -Guest $false -Key "MyKey" -Locale "MyLocale" -Name "MyName" -Self "MySelf" -TimeZone "MyTimeZone" # User | The request object with the user that the issue is assigned to.
...
<a id="Invoke-BulkFetchIssues"></a>
# **Invoke-BulkFetchIssues**
> BulkIssueResults Invoke-BulkFetchIssues<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-BulkFetchIssueRequestBean] <PSCustomObject><br>
...
$BulkFetchIssueRequestBean = Initialize-BulkFetchIssueRequestBean -Expand "MyExpand" -Fields "MyFields" -FieldsByKeys $false -IssueIdsOrKeys "MyIssueIdsOrKeys" -Properties "MyProperties" # BulkFetchIssueRequestBean | A JSON object containing the information about which issues and fields to fetch.

# Bulk fetch issues
try {
    $Result = Invoke-BulkFetchIssues -BulkFetchIssueRequestBean $BulkFetchIssueRequestBean
} catch {
    Write-Host ("Exception occurred when calling Invoke-BulkFetchIssues: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**BulkIssueResults**](BulkIssueResults.md) (PSCustomObject)
...
$OverrideScreenSecurity = $true # Boolean | Whether screen security is overridden to enable hidden fields to be edited. Available to Connect and Forge app users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) and Forge apps acting on behalf of users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). (optional) (default to $false)
$OverrideEditableFlag = $true # Boolean | Whether screen security is overridden to enable uneditable fields to be edited. Available to Connect and Forge app users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) and Forge apps acting on behalf of users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). (optional) (default to $false)
...
<a id="Get-BulkChangelogs"></a>
# **Get-BulkChangelogs**
> BulkChangelogResponseBean Get-BulkChangelogs<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-BulkChangelogRequestBean] <PSCustomObject><br>
...
$BulkChangelogRequestBean = Initialize-BulkChangelogRequestBean -FieldIds "MyFieldIds" -IssueIdsOrKeys "MyIssueIdsOrKeys" -MaxResults 0 -NextPageToken "MyNextPageToken" # BulkChangelogRequestBean | A JSON object containing the bulk fetch changelog request filters such as issue IDs and field IDs.

# Bulk fetch changelogs
try {
    $Result = Get-BulkChangelogs -BulkChangelogRequestBean $BulkChangelogRequestBean
} catch {
    Write-Host ("Exception occurred when calling Get-BulkChangelogs: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**BulkChangelogResponseBean**](BulkChangelogResponseBean.md) (PSCustomObject)
...
$IssueIdOrKey = "MyIssueIdOrKey" # String | The ID or key of the issue.
$OverrideScreenSecurity = $true # Boolean | Whether hidden fields are returned. Available to Connect and Forge app users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) and Forge apps acting on behalf of users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). (optional) (default to $false)
$OverrideEditableFlag = $true # Boolean | Whether non-editable fields are returned. Available to Connect and Forge app users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) and Forge apps acting on behalf of users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). (optional) (default to $false)
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-UpdateHistory] <System.Nullable[Boolean]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-FailFast] <System.Nullable[Boolean]><br>
...
$FailFast = $true # Boolean | Whether to fail the request quickly in case of an error while loading fields for an issue. For `failFast=true`, if one field fails, the entire operation fails. For `failFast=false`, the operation will continue even if a field fails. It will return a valid response, but without values for the failed field(s). (optional) (default to $false)

# Get issue
try {
    $Result = Get-Issue -IssueIdOrKey $IssueIdOrKey -Fields $Fields -FieldsByKeys $FieldsByKeys -Expand $Expand -Properties $Properties -UpdateHistory $UpdateHistory -FailFast $FailFast
} catch {
...
<a id="Get-IssueLimitReport"></a>
# **Get-IssueLimitReport**
> IssueLimitReportResponseBean Get-IssueLimitReport<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IsReturningKeys] <System.Nullable[Boolean]><br>
...
$IsReturningKeys = $true # Boolean | Return issue keys instead of issue ids in the response.  Usage: Add `?isReturningKeys=true` to the end of the path to request issue keys. (optional) (default to $false)

# Get issue limit report
try {
    $Result = Get-IssueLimitReport -IsReturningKeys $IsReturningKeys
} catch {
    Write-Host ("Exception occurred when calling Get-IssueLimitReport: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**IssueLimitReportResponseBean**](IssueLimitReportResponseBean.md) (PSCustomObject)
...
$SkipRemoteOnlyCondition = $true # Boolean | Whether transitions with the condition *Hide From User Condition* are included in the response. Available to Connect and Forge app users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg) and Forge apps acting on behalf of users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). (optional) (default to $false)
