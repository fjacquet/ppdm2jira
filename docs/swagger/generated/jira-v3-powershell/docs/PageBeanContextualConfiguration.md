...
**Values** | [**ContextualConfiguration[]**](ContextualConfiguration.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanContextualConfiguration = Initialize-JiraApiReferencePageBeanContextualConfiguration  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanContextualConfiguration | ConvertTo-JSON
```
