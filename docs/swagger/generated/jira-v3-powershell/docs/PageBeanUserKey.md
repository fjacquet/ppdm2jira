...
**Values** | [**UserKey[]**](UserKey.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanUserKey = Initialize-JiraApiReferencePageBeanUserKey  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanUserKey | ConvertTo-JSON
```
