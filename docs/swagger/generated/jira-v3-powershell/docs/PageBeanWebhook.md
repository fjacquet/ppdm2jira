...
**Values** | [**Webhook[]**](Webhook.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanWebhook = Initialize-JiraApiReferencePageBeanWebhook  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanWebhook | ConvertTo-JSON
```
