...
**Values** | [**ComponentWithIssueCount[]**](ComponentWithIssueCount.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanComponentWithIssueCount = Initialize-JiraApiReferencePageBeanComponentWithIssueCount  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanComponentWithIssueCount | ConvertTo-JSON
```
