...
**Values** | [**FieldConfigurationDetails[]**](FieldConfigurationDetails.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanFieldConfigurationDetails = Initialize-JiraApiReferencePageBeanFieldConfigurationDetails  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanFieldConfigurationDetails | ConvertTo-JSON
```
