...
**Values** | [**IssueFieldOption[]**](IssueFieldOption.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanIssueFieldOption = Initialize-JiraApiReferencePageBeanIssueFieldOption  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanIssueFieldOption | ConvertTo-JSON
```
