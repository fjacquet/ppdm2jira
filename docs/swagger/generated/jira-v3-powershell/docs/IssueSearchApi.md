# JiraApiReference.JiraApiReference\Api.IssueSearchApi

All URIs are relative to *https://your-domain.atlassian.net*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-CountIssues**](IssueSearchApi.md#Invoke-CountIssues) | **POST** /rest/api/3/search/approximate-count | Count issues using JQL
...
[**Search-AndReconsileIssuesUsingJql**](IssueSearchApi.md#Search-AndReconsileIssuesUsingJql) | **GET** /rest/api/3/search/jql | Search for issues using JQL enhanced search (GET)
[**Search-AndReconsileIssuesUsingJqlPost**](IssueSearchApi.md#Search-AndReconsileIssuesUsingJqlPost) | **POST** /rest/api/3/search/jql | Search for issues using JQL enhanced search (POST)
[**Search-ForIssuesUsingJql**](IssueSearchApi.md#Search-ForIssuesUsingJql) | **GET** /rest/api/3/search | Currently being removed. Search for issues using JQL (GET)
[**Search-ForIssuesUsingJqlPost**](IssueSearchApi.md#Search-ForIssuesUsingJqlPost) | **POST** /rest/api/3/search | Currently being removed. Search for issues using JQL (POST)


<a id="Invoke-CountIssues"></a>
# **Invoke-CountIssues**
> JQLCountResultsBean Invoke-CountIssues<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JQLCountRequestBean] <PSCustomObject><br>
...
$JQLCountRequestBean = Initialize-JQLCountRequestBean -Jql "MyJql" # JQLCountRequestBean | A JSON object containing the search request.

# Count issues using JQL
try {
    $Result = Invoke-CountIssues -JQLCountRequestBean $JQLCountRequestBean
} catch {
    Write-Host ("Exception occurred when calling Invoke-CountIssues: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
[**JQLCountResultsBean**](JQLCountResultsBean.md) (PSCustomObject)
...
<a id="Search-AndReconsileIssuesUsingJql"></a>
# **Search-AndReconsileIssuesUsingJql**
> SearchAndReconcileResults Search-AndReconsileIssuesUsingJql<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Jql] <String><br>
...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ReconcileIssues] <System.Nullable[Int64][]><br>
...
$Properties = "MyProperties" # String[] | A list of up to 5 issue properties to include in the results. This parameter accepts a comma-separated list. (optional)
$FieldsByKeys = $true # Boolean | Reference fields by their key (rather than ID). The default is `false`. (optional) (default to $false)
$FailFast = $true # Boolean | Fail this request early if we can't retrieve all field data. (optional) (default to $false)
$ReconcileIssues = 0 # Int64[] | Strong consistency issue ids to be reconciled with search results. Accepts max 50 ids. This list of ids should be consistent with each paginated request across different pages. (optional)

# Search for issues using JQL enhanced search (GET)
try {
    $Result = Search-AndReconsileIssuesUsingJql -Jql $Jql -NextPageToken $NextPageToken -MaxResults $MaxResults -Fields $Fields -Expand $Expand -Properties $Properties -FieldsByKeys $FieldsByKeys -FailFast $FailFast -ReconcileIssues $ReconcileIssues
} catch {
    Write-Host ("Exception occurred when calling Search-AndReconsileIssuesUsingJql: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
 ...
 **Properties** | [**String[]**](String.md)| A list of up to 5 issue properties to include in the results. This parameter accepts a comma-separated list. | [optional] 
 ...
 **ReconcileIssues** | [**Int64[]**](Int64.md)| Strong consistency issue ids to be reconciled with search results. Accepts max 50 ids. This list of ids should be consistent with each paginated request across different pages. | [optional] 

### Return type

[**SearchAndReconcileResults**](SearchAndReconcileResults.md) (PSCustomObject)
...
<a id="Search-AndReconsileIssuesUsingJqlPost"></a>
# **Search-AndReconsileIssuesUsingJqlPost**
> SearchAndReconcileResults Search-AndReconsileIssuesUsingJqlPost<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SearchAndReconcileRequestBean] <PSCustomObject><br>
...
$SearchAndReconcileRequestBean = Initialize-SearchAndReconcileRequestBean -Expand "MyExpand" -Fields "MyFields" -FieldsByKeys $false -Jql "MyJql" -MaxResults 0 -NextPageToken "MyNextPageToken" -Properties "MyProperties" -ReconcileIssues 0 # SearchAndReconcileRequestBean | 

# Search for issues using JQL enhanced search (POST)
try {
    $Result = Search-AndReconsileIssuesUsingJqlPost -SearchAndReconcileRequestBean $SearchAndReconcileRequestBean
} catch {
    Write-Host ("Exception occurred when calling Search-AndReconsileIssuesUsingJqlPost: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
$MaxResults = 56 # Int32 | The maximum number of items to return per page. To manage page size, Jira may return fewer items per page where a large number of fields or properties are requested. The greatest number of items returned per page is achieved when requesting `id` or `key` only. (optional) (default to 50)
...
# Currently being removed. Search for issues using JQL (GET)
try {
    $Result = Search-ForIssuesUsingJql -Jql $Jql -StartAt $StartAt -MaxResults $MaxResults -ValidateQuery $ValidateQuery -Fields $Fields -Expand $Expand -Properties $Properties -FieldsByKeys $FieldsByKeys -FailFast $FailFast
} catch {
 ...
 **MaxResults** | **Int32**| The maximum number of items to return per page. To manage page size, Jira may return fewer items per page where a large number of fields or properties are requested. The greatest number of items returned per page is achieved when requesting &#x60;id&#x60; or &#x60;key&#x60; only. | [optional] [default to 50]
