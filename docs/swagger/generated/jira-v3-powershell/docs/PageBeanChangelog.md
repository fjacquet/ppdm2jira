...
**Values** | [**Changelog[]**](Changelog.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanChangelog = Initialize-JiraApiReferencePageBeanChangelog  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanChangelog | ConvertTo-JSON
```
