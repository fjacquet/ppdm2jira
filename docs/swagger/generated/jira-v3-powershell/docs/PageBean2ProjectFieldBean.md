...
**Values** | [**ProjectFieldBean[]**](ProjectFieldBean.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBean2ProjectFieldBean = Initialize-JiraApiReferencePageBean2ProjectFieldBean  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBean2ProjectFieldBean | ConvertTo-JSON
```
