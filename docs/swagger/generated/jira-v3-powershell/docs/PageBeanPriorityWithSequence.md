...
**Values** | [**PriorityWithSequence[]**](PriorityWithSequence.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanPriorityWithSequence = Initialize-JiraApiReferencePageBeanPriorityWithSequence  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanPriorityWithSequence | ConvertTo-JSON
```
