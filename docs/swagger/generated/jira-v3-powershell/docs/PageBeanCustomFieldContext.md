...
**Values** | [**CustomFieldContext[]**](CustomFieldContext.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanCustomFieldContext = Initialize-JiraApiReferencePageBeanCustomFieldContext  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanCustomFieldContext | ConvertTo-JSON
```
