# JiraApiReference.JiraApiReference\Api.JiraExpressionsApi
...
[**Invoke-EvaluateJSISJiraExpression**](JiraExpressionsApi.md#Invoke-EvaluateJSISJiraExpression) | **POST** /rest/api/3/expression/evaluate | Evaluate Jira expression using enhanced search API
[**Invoke-EvaluateJiraExpression**](JiraExpressionsApi.md#Invoke-EvaluateJiraExpression) | **POST** /rest/api/3/expression/eval | Currently being removed. Evaluate Jira expression
...
<a id="Invoke-EvaluateJSISJiraExpression"></a>
# **Invoke-EvaluateJSISJiraExpression**
> JExpEvaluateJiraExpressionResultBean Invoke-EvaluateJSISJiraExpression<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-JiraExpressionEvaluateRequestBean] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Expand] <String><br>
...
$JexpEvaluateCtxJqlIssues = Initialize-JexpEvaluateCtxJqlIssues -MaxResults 0 -NextPageToken "MyNextPageToken" -Query "MyQuery"
$JexpEvaluateCtxIssues = Initialize-JexpEvaluateCtxIssues -Jql $JexpEvaluateCtxJqlIssues

$JiraExpressionEvaluateContextBean = Initialize-JiraExpressionEvaluateContextBean -Board 0 -Custom $CustomContextVariable -CustomerRequest 0 -Issue $IdOrKeyBean -Issues $JexpEvaluateCtxIssues -Project $IdOrKeyBean -ServiceDesk 0 -Sprint 0

$JiraExpressionEvaluateRequestBean = Initialize-JiraExpressionEvaluateRequestBean -Context $JiraExpressionEvaluateContextBean -Expression "{ key: issue.key, type: issue.issueType.name, links: issue.links.map(link => link.linkedIssue.id) }" # JiraExpressionEvaluateRequestBean | The Jira expression and the evaluation context.
...
# Evaluate Jira expression using enhanced search API
try {
    $Result = Invoke-EvaluateJSISJiraExpression -JiraExpressionEvaluateRequestBean $JiraExpressionEvaluateRequestBean -Expand $Expand
} catch {
    Write-Host ("Exception occurred when calling Invoke-EvaluateJSISJiraExpression: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**JExpEvaluateJiraExpressionResultBean**](JExpEvaluateJiraExpressionResultBean.md) (PSCustomObject)
