# JiraApiReference.JiraApiReference\Api.ProjectClassificationLevelsApi
...
[**Get-ProjectClassificationConfig**](ProjectClassificationLevelsApi.md#Get-ProjectClassificationConfig) | **GET** /rest/api/3/project/{projectIdOrKey}/classification-config | Get the classification configuration for a project
...
<a id="Get-ProjectClassificationConfig"></a>
# **Get-ProjectClassificationConfig**
> AnyType Get-ProjectClassificationConfig<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ProjectIdOrKey] <String><br>
...
# Get the classification configuration for a project
try {
    $Result = Get-ProjectClassificationConfig -ProjectIdOrKey $ProjectIdOrKey
} catch {
    Write-Host ("Exception occurred when calling Get-ProjectClassificationConfig: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
