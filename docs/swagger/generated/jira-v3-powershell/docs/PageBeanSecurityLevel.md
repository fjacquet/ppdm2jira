...
**Values** | [**SecurityLevel[]**](SecurityLevel.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanSecurityLevel = Initialize-JiraApiReferencePageBeanSecurityLevel  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanSecurityLevel | ConvertTo-JSON
```
