...
**Values** | [**IssueTypeScreenSchemeItem[]**](IssueTypeScreenSchemeItem.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanIssueTypeScreenSchemeItem = Initialize-JiraApiReferencePageBeanIssueTypeScreenSchemeItem  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanIssueTypeScreenSchemeItem | ConvertTo-JSON
```
