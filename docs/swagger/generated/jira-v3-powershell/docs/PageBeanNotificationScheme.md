...
**Values** | [**NotificationScheme[]**](NotificationScheme.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanNotificationScheme = Initialize-JiraApiReferencePageBeanNotificationScheme  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanNotificationScheme | ConvertTo-JSON
```
