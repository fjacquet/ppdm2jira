...
**Values** | [**UiModificationDetails[]**](UiModificationDetails.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanUiModificationDetails = Initialize-JiraApiReferencePageBeanUiModificationDetails  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanUiModificationDetails | ConvertTo-JSON
```
