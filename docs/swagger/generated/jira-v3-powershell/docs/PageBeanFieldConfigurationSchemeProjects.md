...
```powershell
$PageBeanFieldConfigurationSchemeProjects = Initialize-JiraApiReferencePageBeanFieldConfigurationSchemeProjects  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanFieldConfigurationSchemeProjects | ConvertTo-JSON
```
