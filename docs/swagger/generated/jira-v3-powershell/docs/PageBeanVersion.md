...
**Values** | **Version[]** | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanVersion = Initialize-JiraApiReferencePageBeanVersion  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanVersion | ConvertTo-JSON
```
