...
**Values** | [**GetFieldAssociationSchemeResponse[]**](GetFieldAssociationSchemeResponse.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBean2GetFieldAssociationSchemeResponse = Initialize-JiraApiReferencePageBean2GetFieldAssociationSchemeResponse  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBean2GetFieldAssociationSchemeResponse | ConvertTo-JSON
```
