# JiraApiReference.JiraApiReference\Api.AppDataPoliciesApi

All URIs are relative to *https://your-domain.atlassian.net*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Get-Policies**](AppDataPoliciesApi.md#Get-Policies) | **GET** /rest/api/3/data-policy/project | Get data policy for projects
[**Get-Policy**](AppDataPoliciesApi.md#Get-Policy) | **GET** /rest/api/3/data-policy | Get data policy for the workspace
