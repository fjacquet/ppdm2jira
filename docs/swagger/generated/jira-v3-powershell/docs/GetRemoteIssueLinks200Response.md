...
```powershell
$GetRemoteIssueLinks200Response = Initialize-JiraApiReferenceGetRemoteIssueLinks200Response  -Application null `
 -GlobalId null `
 -Id null `
 -Object null `
 -Relationship null `
...
```powershell
$GetRemoteIssueLinks200Response | ConvertTo-JSON
```
