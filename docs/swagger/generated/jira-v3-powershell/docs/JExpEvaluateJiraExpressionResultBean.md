...
```powershell
$JExpEvaluateJiraExpressionResultBean = Initialize-JiraApiReferenceJExpEvaluateJiraExpressionResultBean  -Meta null `
 -Value null
```

- Convert the resource to JSON
```powershell
$JExpEvaluateJiraExpressionResultBean | ConvertTo-JSON
```
