...
**Values** | [**PrioritySchemeWithPaginatedPrioritiesAndProjects[]**](PrioritySchemeWithPaginatedPrioritiesAndProjects.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects = Initialize-JiraApiReferencePageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects | ConvertTo-JSON
```
