...
**Values** | [**JqlFunctionPrecomputationBean[]**](JqlFunctionPrecomputationBean.md) | The list of items. | [optional] [readonly] 

## Examples

- Prepare the resource
```powershell
$PageBean2JqlFunctionPrecomputationBean = Initialize-JiraApiReferencePageBean2JqlFunctionPrecomputationBean  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBean2JqlFunctionPrecomputationBean | ConvertTo-JSON
```
