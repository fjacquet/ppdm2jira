...
```powershell
$PatchAssetRequestProtectionPolicy = Initialize-PpdmApiReferencePatchAssetRequestProtectionPolicy  -BackupRank null `
 -Id null
```

- Convert the resource to JSON
```powershell
$PatchAssetRequestProtectionPolicy | ConvertTo-JSON
```
