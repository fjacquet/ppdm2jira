...
```powershell
$DataDomainMTreeRequest = Initialize-PpdmApiReferenceDataDomainMTreeRequest  -AppOptimizedCompression null `
 -Attributes null `
...
```powershell
$DataDomainMTreeRequest | ConvertTo-JSON
```
